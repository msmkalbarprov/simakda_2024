...
class BankKalbarController extends Controller
{
    ...
    function cek_npwp(Request $request)
    {
        if ($request->ajax()) {
            ...
            $curl = curl_init();
            curl_setopt_array($curl, array(
                CURLOPT_URL => "http://192.168.9.2:10090/sppd/sppd/npwp/validasi",
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => "",
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    public function isiListPot(Request $request)
    {
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
            CURLOPT_URL => "http://192.168.9.2:10090/sppd/sppd/ntp/validasi",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
    ...
    public function createBilling(Request $request)
    {
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
            CURLOPT_URL => "http://192.168.9.2:10090/sppd/sppd/idbilling/create",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
    ...
    public function cekBilling(Request $request)
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => "http://192.168.9.2:10090/sppd/sppd/idbilling/validasi",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
