...
class BankKalbarController extends Controller
{
    ...
    public function createBilling(Request $request)
    {
        ...
        $data['nomorPokokWajibPajak']           = $npwp;
        $data['kodeMap']                        = $kode_map;
        $data['kodeSetor']                      = $kode_setor;
        $data['masaPajak']                      = $masa_pajak;
        $data['tahunPajak']                     = $tahun_pajak;
        $data['jumlahBayar']                    = $jumlah_bayar;
        $data['nomorObjekPajak']                = $nop;
        $data['nomorSK']                        = $no_sk;
        $data['nomorPokokWajibPajakPenyetor']   = $npwp_setor;
        $data['namaWajibPajak']                 = $nama_wajib_pajak;
        $data['alamatWajibPajak']               = $alamat_wajib_pajak;
        $data['kota']                           = $kota;
        $data['nik']                            = $nik;
        $data['nomorPokokWajibPajakRekanan']    = $npwp_rekanan;
        $data['nikRekanan']                     = $nik_rekanan;
        $data['nomorFakturPajak']               = $no_faktur;
        $data['nomorSKPD']                      = $kd_skpd;
        $data['nomorSPM']                       = $no_spm;
        $datakirim = json_encode($data);
        $api_key = $this->get_token_api();
        $headers = array(
            'Authorization: Bearer ' . $api_key,
