...
class BendaharaUmumDaerahController extends Controller
{
    ...
    public function realisasiKkpd(Request $request)
    {
        ...
        if ($tipe == 'SP2D') {
            ...
            (select SUM(nilai) from trdrka where z.kd_skpd=kd_skpd and jns_ang=? and left(kd_rek6,2)=?) as anggaran_modal,
            (select SUM(nilai) from trdrka where z.kd_skpd=kd_skpd and jns_ang=? and left(kd_rek6,4)=?) as anggaran_barjas,
