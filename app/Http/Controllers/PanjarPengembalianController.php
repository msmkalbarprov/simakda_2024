...
class PanjarPengembalianController extends Controller
{
    public function index()
    {
        ...
        $data = [
            'dpanjar' => DB::table('tr_panjar_cmsbank')->select('no_panjar', 'tgl_panjar', 'kd_skpd','nilai')->where('kd_skpd',$kd_skpd)->whereIn('jns',['1'])->orderByRaw("no_panjar")->get()
        ];

        return view('skpd.panjar_cms.index');
    }

    public function loadData()
    {
        $kd_skpd = Auth::user()->kd_skpd;
        $data = DB::table('tr_panjar_cmsbank')->select('*')->where('kd_skpd', $kd_skpd)->whereIn('jns',['1'])->orderByRaw("no_panjar")->get();
        return DataTables::of($data)->addIndexColumn()->addColumn('aksi', function ($row) {
                $btn = '<a href="' . route("panjar_cms.edit", Crypt::encryptString($row->no_panjar)) . '" class="btn btn-info btn-sm" style="margin-right:4px"><i class="fa fa-edit"></i></a>';
    ...
    public function edit($no_panjar)
    {
       ...
       // dd($data['data_panjar']);
        ...
        //  return;
        return view('skpd.panjar_cms.edit')->with($data);
    }
    ...
    public function create()
    {
        ...
        return view('skpd.panjar_cms.create')->with($data);;
    }
    ...
    public function cetakList(Request $request){
        ...
        return view('skpd.panjar_cms.cetak')->with($data);
    }
}
