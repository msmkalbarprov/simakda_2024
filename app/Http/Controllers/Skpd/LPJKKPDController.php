...
class LPJKKPDController extends Controller
{
    ...
    public function indexSkpdTanpaUnit()
    {
        ...
        return view('skpd.lpj_kkpd.skpd_tanpa_unit.index')->with($data);
    }
    ...
    public function loadSkpdTanpaUnit()
    {
        ...
        return DataTables::of($data)->addIndexColumn()->addColumn('aksi', function ($row) {
            $btn = '<a href="' . route("lpj_kkpd_tanpa_unit.edit",  ['no_lpj' => Crypt::encrypt($row->no_lpj), 'kd_skpd' => Crypt::encrypt($row->kd_skpd)]) . '" class="btn btn-warning btn-sm"  style="margin-right:4px"><i class="uil-edit"></i></a>';
    ...
    public function tambahSkpdTanpaUnit()
    {
        ...
        if ($total_skpd > 1) {
            ...
            return redirect()->route('lpj_kkpd_tanpa_unit.index')
        ...
        $data = [
            ...
            'tanggal_awal' => collect(DB::select("SELECT DATEADD(DAY,1,MAX(tgl_akhir)) as tanggal_awal FROM trhlpj_kkpd WHERE jenis=? AND kd_skpd = ?", ['1', $kd_skpd]))->first()->tanggal_awal
        ];

        return view('skpd.lpj_kkpd.skpd_tanpa_unit.create')->with($data);
    }
    ...
    public function detailSkpdTanpaUnit(Request $request)
    {
        ...
        $data1 = DB::table('trdtransout as a')
            ...
            ->whereRaw("(a.no_bukti+a.kd_sub_kegiatan+a.kd_rek6+a.kd_skpd) NOT IN(SELECT (no_bukti+kd_sub_kegiatan+kd_rek6+kd_skpd) FROM trlpj_kkpd) AND b.panjar not in ('3','5') AND b.tgl_bukti >= ? and b.tgl_bukti <= ? and b.jns_spp='1' and b.kd_skpd=?", [$tgl_awal, $tgl_akhir, $kd_skpd]);
        ...
        $data2 = DB::table('trdtransout as a')
            ...
            ->selectRaw("b.kd_skpd,b.tgl_bukti,a.kd_sub_kegiatan,a.nm_sub_kegiatan,a.kd_rek6,a.nm_rek6,a.no_bukti,a.nilai,a.kd_skpd as kd_skpd1,kkpd")
            ->whereRaw("(a.no_bukti+a.kd_sub_kegiatan+a.kd_rek6+a.kd_skpd) NOT IN(SELECT (no_bukti+kd_sub_kegiatan+kd_rek6+kd_skpd) FROM trlpj_kkpd) AND b.panjar in ('3','5') AND b.tgl_bukti >= ? and b.tgl_bukti <= ? and b.jns_spp='1' and b.kd_skpd=?", [$tgl_awal, $tgl_akhir, $kd_skpd])
            ->unionAll($data1);
    ...
    public function simpanSkpdTanpaUnit(Request $request)
    {
        ...
        DB::beginTransaction();
        try {
            $no_lpj = $data['no_lpj'] . "/LPJ/KKPD/" . $data['kd_skpd'] . "/" . tahun_anggaran();

            $cek_lpj = DB::table('trhlpj_kkpd')
            ...
            if (isset($rincian_data)) {
                foreach ($rincian_data as $data => $value) {
                    $data = [
                        ...
                        'kd_bp_skpd' => $kd_skpd,
                        'no_lpj_unit' => $no_lpj,
                        'kkpd' => $rincian_data[$data]['kkpd'],
                    ];
                    DB::table('trlpj_kkpd')->insert($data);
                }
            }
    ...
    public function editSkpdTanpaUnit($no_lpj, $kd_skpd)
    {
        ...
        $data = [
            ...
            'lpj' => DB::table('trhlpj_kkpd as a')
                ...
                ->orderBy('a.no_lpj')
                ->first(),
            'detail_lpj' => DB::table('trhlpj_kkpd as a')
                ->join('trlpj_kkpd as b', function ($join) {
                ...
                ->get(),
            'total_detail' => DB::table('trhlpj_kkpd as a')
                ->join('trlpj_kkpd as b', function ($join) {
                    $join->on('a.no_lpj', '=', 'b.no_lpj');
                    $join->on('a.kd_skpd', '=', 'b.kd_skpd');
                })
        ...
        return view('skpd.lpj_kkpd.skpd_tanpa_unit.edit')->with($data);
    }
    ...
    public function sptbSkpdTanpaUnit(Request $request)
    {
        ...
        $view = view('skpd.lpj_kkpd.skpd_tanpa_unit.cetak.sptb')->with($data);
    ...
    public function rincianSkpdTanpaUnit(Request $request)
    {
        ...
        $view = view('skpd.lpj_kkpd.skpd_tanpa_unit.cetak.rincian')->with($data);
    ...
    public function rekapSkpdTanpaUnit(Request $request)
    {
        ...
        $view = view('skpd.lpj_kkpd.skpd_tanpa_unit.cetak.rekap')->with($data);
    ...
    public function indexSkpdDanUnit()
    {
        ...
        return view('skpd.lpj_kkpd.skpd_dan_unit.index')->with($data);
    }
    ...
    public function loadSkpdDanUnit()
    {
        ...
        $data = DB::table('trhlpj_kkpd as a')
            ...
            ->get();
        return DataTables::of($data)->addIndexColumn()->addColumn('aksi', function ($row) {
            $btn = '<a href="' . route("lpj_kkpd_dan_unit.edit", ['no_lpj' => Crypt::encrypt($row->no_lpj), 'kd_skpd' => Crypt::encrypt($row->kd_skpd)]) . '" class="btn btn-warning btn-sm"  style="margin-right:4px"><i class="uil-edit"></i></a>';
            if ($row->status == '1' || $row->status == '2') {
                $btn .= "";
            } else {
                $btn .= '<a href="javascript:void(0);" onclick="hapus(\'' . $row->no_lpj . '\',\'' . $row->kd_skpd . '\');" class="btn btn-danger btn-sm" style="margin-right:4px"><i class="uil-trash"></i></a>';
    ...
    public function tambahSkpdDanUnit()
    {
        ...
        if ($total_skpd == 1) {
            ...
            return redirect()->route('lpj_kkpd_dan_unit.index')
        ...
        return view('skpd.lpj_kkpd.skpd_dan_unit.create')->with($data);
    }
    ...
    public function loadLpjSkpdDanUnit(Request $request)
    {
        ...
        $data = DB::table('trhlpj_unit_kkpd as a')
            ->selectRaw("a.*,(SELECT SUM(nilai) FROM trlpj_kkpd WHERE no_lpj_unit=a.no_lpj) AS nilai,(SELECT nm_skpd FROM ms_skpd WHERE kd_skpd=a.kd_skpd) AS nm_skpd")
            ->where(['a.status' => '1', 'a.jenis' => '1', 'a.status_validasi' => '1'])
            ->whereRaw("a.no_lpj NOT IN (SELECT no_lpj_unit FROM trlpj_kkpd WHERE a.no_lpj=no_lpj_unit AND a.kd_skpd=kd_skpd AND (no_lpj <> '' OR kd_bp_skpd <> ''))")
    ...
    public function simpanSkpdDanUnit(Request $request)
    {
        ...
        try {
            ...
            $no_lpj = $data['no_lpj'] . "/LPJ/GLOBAL/KKPD/" . $data['kd_skpd'] . "/" . tahun_anggaran();
    ...
    public function editSkpdDanUnit($no_lpj, $kd_skpd)
    {
        $no_lpj = Crypt::decrypt($no_lpj);
        $kd_skpd = Crypt::decrypt($kd_skpd);
        $arr = explode("/", $no_lpj);
        ...
        $data = [
            ...
            'detail_lpj' => DB::table('trhlpj_kkpd as a')
                ...
                ->join('trhlpj_unit_kkpd as c', function ($join) {
                    $join->on('b.no_lpj_unit', '=', 'c.no_lpj');
                    $join->on('b.kd_skpd', '=', 'c.kd_skpd');
                })
                ->select('a.no_lpj as lpj_global', 'c.*')
                ->selectRaw("(SELECT SUM(nilai) FROM trlpj_kkpd WHERE no_lpj_unit=c.no_lpj) AS nilai")
                ->where(['a.no_lpj' => $no_lpj, 'a.kd_skpd' => $kd_skpd, 'a.jenis' => '1'])
                ->distinct()
                ->get(),
            'skpd' => DB::table('ms_skpd')
        ...
        return view('skpd.lpj_kkpd.skpd_dan_unit.edit')->with($data);
    }
    ...
    public function updateSkpdDanUnit(Request $request)
    {
        ...
        try {
            ...
            $cek_terima = DB::table('trhlpj_kkpd')
    ...
    public function rincianSkpdDanUnit(Request $request)
    {
        ...
        $view = view('skpd.lpj_kkpd.skpd_dan_unit.cetak.rincian')->with($data);
    ...
    public function indexSkpdAtauUnit()
    {
        ...
        return view('skpd.lpj_kkpd.skpd_atau_unit.index')->with($data);
    }
    ...
    public function loadSkpdAtauUnit()
    {
        ...
        return DataTables::of($data)->addIndexColumn()->addColumn('aksi', function ($row) {
            $btn = '<a href="' . route("lpj_kkpd_atau_unit.edit", ['no_lpj' => Crypt::encrypt($row->no_lpj), 'kd_skpd' => Crypt::encrypt($row->kd_skpd)]) . '" class="btn btn-warning btn-sm"  style="margin-right:4px"><i class="uil-edit"></i></a>';
            if ($row->status == '1' || $row->status == '2') {
                $btn .= "";
            } else {
                $btn .= '<a href="javascript:void(0);" onclick="hapus(\'' . $row->no_lpj . '\',\'' . $row->kd_skpd . '\');" class="btn btn-danger btn-sm" style="margin-right:4px"><i class="uil-trash"></i></a>';
    ...
    public function tambahSkpdAtauUnit()
    {
        ...
        if ($total_skpd == 1) {
            // return redirect()->back()->with(['message' => 'Menu Hanya Untuk SKPD/Unit!', 'alert' => 'alert-danger']);
            return redirect()->route('lpj_kkpd_atau_unit.index')
                ->with(['message', 'Menu Hanya Untuk SKPD/Unit!', 'alert' => 'alert-danger']);
        }
        ...
        $data = [
            'skpd' => DB::table('ms_skpd')
                ...
                ->where(['kd_skpd' => $kd_skpd])
                ->first(),
            'tanggal_awal' => collect(DB::select("SELECT DATEADD(DAY,1,MAX(tgl_akhir)) as tanggal_awal FROM trhlpj_unit_kkpd WHERE jenis=? AND kd_skpd = ?", ['1', $kd_skpd]))->first()->tanggal_awal
        ];

        return view('skpd.lpj_kkpd.skpd_atau_unit.create')->with($data);
    }
    ...
    public function detailSkpdAtauUnit(Request $request)
    {
        ...
        $data = DB::select("SELECT * FROM (SELECT b.kd_skpd,b.tgl_bukti,a.kd_sub_kegiatan,a.nm_sub_kegiatan,a.kd_rek6,a.nm_rek6,a.no_bukti,a.nilai,a.kd_skpd as kd_skpd1,kkpd FROM trdtransout a inner join trhtransout b on
                  a.no_bukti=b.no_bukti AND a.kd_skpd = b.kd_skpd WHERE (a.no_bukti+a.kd_sub_kegiatan+a.kd_rek6+a.kd_skpd) NOT IN(SELECT (no_bukti+kd_sub_kegiatan+kd_rek6+kd_skpd) FROM trlpj_kkpd) AND b.panjar not in ('3','5') AND b.tgl_bukti >= ? and b.tgl_bukti <= ? and b.jns_spp='1' and b.kd_skpd=?
                  ...
                  a.no_bukti=b.no_bukti AND a.kd_skpd = b.kd_skpd WHERE (a.no_bukti+a.kd_sub_kegiatan+a.kd_rek6+a.kd_skpd) NOT IN(SELECT (no_bukti+kd_sub_kegiatan+kd_rek6+kd_skpd) FROM trlpj_kkpd) AND b.panjar in ('3','5') AND b.tgl_bukti >= ? and b.tgl_bukti <= ? and b.jns_spp='1' and b.kd_skpd=?
                  )z
    ...
    public function simpanSkpdAtauUnit(Request $request)
    {
        ...
        try {
            ...
            $cek_lpj = DB::table('trhlpj_unit_kkpd')->where(['no_lpj' => $no_lpj, 'kd_skpd' => $kd_skpd])->count();
            if ($cek_lpj > 0) {
                return response()->json([
                    'message' => '2'
                ]);
    ...
    public function editSkpdAtauUnit($no_lpj, $kd_skpd)
    {
        $no_lpj = Crypt::decrypt($no_lpj);
        $kd_skpd = Crypt::decrypt($kd_skpd);
        $arr = explode("/", $no_lpj);
        ...
        $data = [
            'nomor' => $arr[0],
            'lpj' => DB::table('trhlpj_unit_kkpd as a')
                ->selectRaw("a.*,(SELECT nm_skpd FROM ms_skpd WHERE kd_skpd = a.kd_skpd) as nm_skpd")
                ->where(['a.kd_skpd' => $kd_skpd, 'a.jenis' => '1', 'a.no_lpj' => $no_lpj])
                ->first(),
            'detail_lpj' => DB::table('trhlpj_unit_kkpd as a')
                ->join('trlpj_kkpd as b', function ($join) {
                ...
                ->where(['a.no_lpj' => $no_lpj, 'a.kd_skpd' => $kd_skpd, 'a.jenis' => '1'])
                ->get(),
            'total_detail' => DB::table('trhlpj_unit_kkpd as a')
                ->join('trlpj_kkpd as b', function ($join) {
                    $join->on('a.no_lpj', '=', 'b.no_lpj_unit');
                    $join->on('a.kd_skpd', '=', 'b.kd_skpd');
                })
        ...
        return view('skpd.lpj_kkpd.skpd_atau_unit.edit')->with($data);
    }
    ...
    public function updateSkpdAtauUnit(Request $request)
    {
        ...
        try {
            ...
            $cek_terima = DB::table('trhlpj_unit_kkpd')->where(['no_lpj' => $no_lpj, 'kd_skpd' => $data['kd_skpd']])->count();
            if ($cek_terima > 0 && $no_lpj != $data['no_lpj_simpan']) {
                return response()->json([
                    'message' => '2'
                ]);
    ...
    public function sptbSkpdAtauUnit(Request $request)
    {
        ...
        $view = view('skpd.lpj_kkpd.skpd_atau_unit.cetak.sptb')->with($data);
    ...
    public function rincianSkpdAtauUnit(Request $request)
    {
        ...
        $view = view('skpd.lpj_kkpd.skpd_atau_unit.cetak.rincian')->with($data);
    ...
    {
        return view('skpd.lpj_kkpd.validasi_lpj.index');
    }
    ...
    public function loadValidasiLpj()
    {
        ...
        return DataTables::of($data)->addIndexColumn()->addColumn('aksi', function ($row) {
            if ($row->status == '2') {
                ...
                $btn = '<a href="' . route("lpj_validasi.edit", ['no_lpj' => Crypt::encrypt($row->no_lpj), 'kd_skpd' => Crypt::encrypt($row->kd_skpd)]) . '" class="btn btn-warning btn-sm"  style="margin-right:4px"><i class="uil-edit"></i></a>';
            }
            return $btn;
        })->rawColumns(['aksi'])->make(true);
    }
    ...
    public function editValidasiLpj($no_lpj, $kd_skpd)
    {
        ...
        if (substr($skpd, 18, 4) != '0000') {
            ...
            return redirect()->route('lpj_validasi.index')
        ...
        return view('skpd.lpj_kkpd.validasi_lpj.edit')->with($data);
    }
    ...
    public function batalSetujuValidasiLpj(Request $request)
    {
        ...
        DB::beginTransaction();
        try {
            $cek_global = DB::table('trlpj_kkpd')
    ...
    public function indexLpjTu()
    {
        ...
        return view('skpd.lpj_kkpd.lpj_tu.index')->with($data);
    }
    ...
    public function tambahLpjTu()
    {
        ...
        return view('skpd.lpj_kkpd.lpj_tu.create')->with($data);
    }
    ...
    public function simpanLpjTu(Request $request)
    {
        ...
        try {
            ...
            if (isset($rincian_data)) {
                foreach ($rincian_data as $item => $value) {
                    $data_insert = [
                        'no_lpj' => $no_lpj,
                        'kd_skpd' => $data['kd_skpd'],
                        'no_bukti' => $rincian_data[$item]['no_bukti'],
                        'tgl_lpj' => $data['tgl_lpj'],
                        'kd_sub_kegiatan' => $rincian_data[$item]['kd_sub_kegiatan'],
                        'keterangan' => $data['keterangan'],
                        'kd_rek6' => $rincian_data[$item]['kd_rek6'],
                        'nm_rek6' => $rincian_data[$item]['nm_rek6'],
                        'nilai' => $rincian_data[$item]['nilai'],
                        'kd_bp_skpd' => $rincian_data[$item]['kd_skpd'],
                        'no_lpj_unit' => $no_lpj,
                    ];
                    DB::table('trlpj_tu')->insert($data_insert);
                }
            }
    ...
    public function editLpjTu($no_lpj, $kd_skpd)
    {
        ...
        return view('skpd.lpj_kkpd.lpj_tu.edit')->with($data);
    }
    ...
    public function sptbLpjTu(Request $request)
    {
        ...
        $view = view('skpd.lpj_kkpd.lpj_tu.cetak.sptb')->with($data);
    ...
    public function rincianLpjTu(Request $request)
    {
        ...
        $view = view('skpd.lpj_kkpd.lpj_tu.cetak.rincian')->with($data);
