...
class UploadKKPDController extends Controller
{
    public function index()
    {
        ...
        return view('skpd.upload_kkpd.index')->with($data);
    }
    ...
    public function loadUpload()
    {
        ...
        $data = DB::table('trhtransout_kkpd as a')
            ...
            ->where(['a.kd_skpd' => $kd_skpd, 'status_verifikasi' => '1', 'status_upload' => '0'])
    ...
    public function draftUpload()
    {
        ...
        $data = DB::table('trhtransout_kkpd as a')
            ...
            ->where(['a.kd_skpd' => $kd_skpd, 'a.status_verifikasi' => '1', 'a.status_upload' => '1', 'a.status_validasi' => '0'])
    ...
    public function loadTransaksi(Request $request)
    {
        ...
        $data = DB::table('trhtransout_kkpd as a')
            ...
            ->where(['a.kd_skpd' => $kd_skpd, 'status_upload' => '0', 'status_verifikasi' => '1'])
    ...
    public function create()
    {
        ...
        return view('skpd.upload_kkpd.create')->with($data);
    }
    ...
    public function prosesUpload(Request $request)
    {
        ...
        try {
            ...
            $no_upload = collect(DB::select("SELECT case when max(nomor+1) is null then 1 else max(nomor+1) end as nomor from (
                ...
                z WHERE kd_skpd=? AND tanggal=?", [$kd_skpd, $kd_skpd, $tanggal]))->first();
            ...
            if (isset($rincian_data)) {
                DB::table('trdupload_kkpd')->insert(array_map(function ($value) use ($nomor, $no_upload1) {
                    return [
        ...
        try {
            ...
            if ($cek->jum > 1) {
                ...
                DB::update("UPDATE
                        ...
                        FROM trhupload_kkpd
                        INNER JOIN (select a.no_upload,b.kd_skpd,a.tgl_upload,b.status_upload,b.no_voucher,b.kd_bp,sum(b.nilai) as total from trhupload_kkpd a left join
                        trdupload_kkpd b on b.kd_bp=a.kd_skpd and a.no_upload=b.no_upload
                        where b.kd_bp=? and a.no_upload=?
                        group by a.no_upload,b.kd_skpd,a.tgl_upload,b.status_upload,b.no_voucher,b.kd_bp) AS Table_B ON trhupload_kkpd.no_upload = Table_B.no_upload AND trhupload_kkpd.kd_skpd = Table_B.kd_skpd
