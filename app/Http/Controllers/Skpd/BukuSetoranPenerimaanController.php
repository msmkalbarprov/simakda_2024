...
class BukuSetoranPenerimaanController extends Controller
{
    ...
    public function cetakRincianObjek(Request $request)
    {
        ...
        $data = [
            ...
            'tanggal1'          => $tanggal1,
            'tanggal2'          => $tanggal2,
            'rincian'           => DB::select("SELECT b.no_sts, a.tgl_sts, a.keterangan, b.rupiah from trhkasin_pkd a inner join trdkasin_pkd b on a.kd_skpd=b.kd_skpd and a.no_sts=b.no_sts where b.kd_skpd=? and b.kd_rek6=? AND a.jns_trans=4 AND (a.tgl_sts BETWEEN ? AND ?) order by tgl_sts, no_sts, rupiah", [$kd_skpd, $rekening, $tanggal1, $tanggal2]),
