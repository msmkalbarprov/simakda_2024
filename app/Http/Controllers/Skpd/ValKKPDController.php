...
class ValKKPDController extends Controller
{
    public function index()
    {
        ...
        return view('skpd.val_kkpd.index')->with($data);
    }
    ...
    public function create()
    {
        ...
        return view('skpd.val_kkpd.create')->with($data);
    }
    ...
    public function draftValidasi()
    {
        ...
        $data = DB::table('trhtransout_kkpd as a')
            ...
            ->where(['a.kd_skpd' => $kd_skpd, 'a.status_upload' => '1', 'a.status_validasi' => '1'])
