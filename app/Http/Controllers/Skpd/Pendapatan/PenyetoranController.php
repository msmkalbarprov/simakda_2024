    ...
    public function validasiPenyetoranLalu(Request $request)
    {
        ...
        try {
            ...
            if ($cek > 0) {
                ...
                DB::insert("INSERT into trhkasin_ppkd(no_kas,tgl_kas,no_sts,kd_skpd,tgl_sts,keterangan,total,kd_sub_kegiatan,jns_trans,sumber)
						select $nomor+ROW_NUMBER() OVER (ORDER BY tgl_kas) AS no_kas, tgl_sts, no_sts, kd_skpd, tgl_sts, keterangan, total, kd_sub_kegiatan, jns_trans, sumber
						FROM (
