                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <a href="index.html" class="mb-5 d-block auth-logo">
                                <img src="{{asset('template/assets/images/logo-dark.png')}}" alt="" height="50" class="logo logo-dark">
                                <img src="{{asset('template/assets/images/logo-light.png')}}" alt="" height="50" class="logo logo-light">
                            </a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="p-2 mt-4">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="mt-3 text-end">
                                            <button type="submit" class="btn btn-primary w-sm waves-effect waves-light  -,k">
                                                {{ __('Login') }}
                                            </button>
