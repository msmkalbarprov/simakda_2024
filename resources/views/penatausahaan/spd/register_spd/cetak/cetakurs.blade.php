...
<body>
    ...
    <div style="text-align: left;">
        <h4 style="margin: 2px 0px" class="unborder">KODE / NAMA SKPD &emsp; &nbsp; : {{ $skpd->kd_skpd }} - {{$skpd->nm_skpd }}</h4>
    ...
    <div style="padding-top: 20px; font-size: 12px; font-family:Open Sans">
        <div style="float: right; text-align: center; padding-right:200px">
            {{ daerah($kd_skpd) }}, {{ tanggal($tgl_ttd) }} <br />
            {{ $ttd->jabatan }},
