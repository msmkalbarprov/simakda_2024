                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <select class="form-control select2-multiple" style="width: 100%" name="bulan_awal" id="bulan_awal">
                                <option value=""></option>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <select class="form-control select2-multiple" style="width: 100%" name="bulan_akhir" id="bulan_akhir">
                                <option value=""></option>
                                @foreach (getMonths() as $key => $value)
                                <option value="{{ $key }}">{{ $value }}</option>
                                @endforeach
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-control select2-multiple" style="width: 100%" name="jenis" id="jenis">
                                <option value=""></option>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select type="text" class="form-control select2-multiple" style="width: 100%" id="jenis_anggaran" name="jenis_anggaran"></select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label" for="status_angkas">Status Angkas</label>
                            <select type="text" class="form-control" style="width: 100%" id="status_angkas" name="status_angkas"></select>
                        </div>
                    </div>
                </div>
                <!-- keterangan -->
