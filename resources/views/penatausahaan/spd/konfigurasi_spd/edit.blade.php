                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nomor" name="nomor"
                                    value="{{ $data_konfig->no_konfig_spd }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="tgl_con" name="tgl_con"
                                    value="{{ $data_konfig->tgl_konfig_spd }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <select class="form-control select2-multiple" style="width: 100%" name="jenis_spd"
                                    id="jenis_spd">
                                    <option value=""></option>
                                    <option value="1" {{ $data_konfig->jenis_spd == '1' ? 'selected' : '' }}>Perbulan
                                    </option>
                                    <option value="2" {{ $data_konfig->jenis_spd == '2' ? 'selected' : '' }}>Triwulan
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="mb-3 row" style="float: right;">
                        <div class="col-md-12" style="text-align: center">
                            ...
                            <a href="{{ route('konfigurasi_spd.index') }}" class="btn btn-warning btn-md">Kembali</a>
                        </div>
                    </div>
                </div>
...
@endsection
@section('js')
    @include('penatausahaan.spd.konfigurasi_spd.js.edit')
@endsection
