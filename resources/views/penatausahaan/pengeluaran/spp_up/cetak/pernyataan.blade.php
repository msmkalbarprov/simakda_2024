...
<body>
    ...
    <div>
        <table style="width: 100%;margin-top:40px;border-collapse:collapse;font-family: Open Sans; font-size:12px"
            id="rincian">
            <tr>
    ...
    <div style="padding-top:20px;">
        <table class="table" style="width: 100%;border-collapse:collapse;font-family: Open Sans; font-size:12px"
            ...
            <tr>
                <td width='50%'></td>
                <td width='50%' style="text-align: center"><b><u>{{ $pa_kpa->nama }}</u></b></td>
            </tr>
            <tr>
                <td width='50%'></td>
