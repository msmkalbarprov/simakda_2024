    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="container-fluid">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4">
                                <input type="text" value="{{ $data_skpd->kd_skpd }}"
                                    class="form-control js-example-responsive" id="kd_skpd" name="kd_skpd" readonly>
                                <input type="hidden" readonly class="form-control js-example-responsive" id="tahun"
                                    name="tahun" value="{{ tahun_anggaran() }}">
                            </div>
                            <label for="nm_opd" class="col-md-2 col-form-label">Nama OPD</label>
                            <div class="col-md-4">
                                <input type="text" value="{{ $data_skpd->nm_skpd }}"
                                    class="form-control js-example-responsive" id="nm_opd" name="nm_opd" readonly>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="tgl_spp" class="col-md-2 col-form-label">Tanggal SPP</label>
                            <div class="col-md-4">
                                <input type="date" class="form-control js-example-responsive" id="tgl_spp"
                                    name="tgl_spp">
                            ...
                            <div class="col-md-4">
                                <select name="kebutuhan_bulan" class="form-control js-example-responsive"
                                    id="kebutuhan_bulan" disabled>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control js-example-responsive"
                                    style="background-color:powderblue;" id="no_spp" name="no_spp" readonly>
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4">
                                <input type="text" readonly class="form-control js-example-responsive" id="npwp"
                                    name="npwp">
                            </div>
                        </div>
                        <div style="float: right;">
                            <button id="simpan" class="btn btn-primary btn-md" type="submit"
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    Input Detail SPP TU
                    <button type="button" style="float: right" id="tambah_rincian" data-toggle="modal"
                        class="btn btn-primary"><i class="bx bx-plus-circle"></i> Tambah Rekening</button>
                </div>
                    ...
                    <div class="mb-2 mt-2 row">
                        ...
                        <div class="col-md-4">
                            <input type="text" style="text-align: right" readonly
                                class="form-control @error('total_nilai') is-invalid @enderror" id="total_nilai"
                                name="total_nilai">
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="text" readonly class="form-control js-example-responsive" id="no_spdd"
                                name="no_spdd">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="kd_sub_keg" class="col-md-3 col-form-label js-example-responsive">Kode Sub
                            Kegiatan</label>
                        <div class="col-md-6">
                            <input type="text" readonly class="form-control js-example-responsive" id="kd_sub_keg"
                                name="kd_sub_keg">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="nm_sub_keg" class="col-md-3 col-form-label js-example-responsive">Nama Sub
                            Kegiatan</label>
                        <div class="col-md-6">
                            <input type="text" readonly class="form-control js-example-responsive" id="nm_sub_keg"
                                name="nm_sub_keg">
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        <label for="kd_sumberdana" class="col-md-3 col-form-label js-example-responsive">Sumber
                            Dana</label>
                        <div class="col-md-6">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-2">
                            <input type="text" readonly class="form-control js-example-responsive" name="total_spd"
                                id="total_spd">
                        </div>
                        <label for="realisasi_angkas"
                            class="col-md-1 col-form-label js-example-responsive">Realisasi</label>
                        <div class="col-md-3">
                            <input type="text" readonly class="form-control js-example-responsive"
                                name="realisasi_spd" id="realisasi_spd">
                        </div>
                        <label for="sisa_angkas" class="col-md-1 col-form-label js-example-responsive">Sisa</label>
                        <div class="col-md-3">
                            <input type="text" readonly class="form-control js-example-responsive"
                                style="background-color:#B0E0E6;" name="sisa_spd" id="sisa_spd">
                        </div>
                    </div>

                    <!-- Total Angkas -->
                    <div class="mb-3 row">
                        <label for="total_angkas" class="col-md-2 col-form-label js-example-responsive">Total Anggaran
                            Kas</label>
                        <div class="col-md-2">
                            <input type="text" readonly class="form-control js-example-responsive" name="total_angkas"
                                id="total_angkas">
                        </div>
                        <label for="realisasi_angkas"
                            class="col-md-1 col-form-label js-example-responsive">Realisasi</label>
                        ...
                        <div class="col-md-3">
                            <input type="text" readonly class="form-control js-example-responsive"
                                style="background-color:#B0E0E6;" name="sisa_angkas" id="sisa_angkas">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-2">
                            <input type="text" readonly class="form-control js-example-responsive"
                                name="total_anggaran" id="total_anggaran">
                        </div>
                        <label for="realisasi_anggaran"
                            class="col-md-1 col-form-label js-example-responsive">Realisasi</label>
                        <div class="col-md-3">
                            <input type="text" readonly class="form-control js-example-responsive"
                                name="realisasi_anggaran" id="realisasi_anggaran">
                        </div>
                        <label for="sisa_anggaran" class="col-md-1 col-form-label js-example-responsive">Sisa</label>
                        <div class="col-md-3">
                            <input type="text" readonly class="form-control js-example-responsive"
                                style="background-color:#B0E0E6;" name="sisa_anggaran" id="sisa_anggaran">
                        </div>
                    </div>

                    <!-- Nilai Sumber Dana -->
                    <div class="mb-3 row">
                        <label for="total_sumber" class="col-md-2 col-form-label js-example-responsive">Sumber
                            Dana</label>
                        <div class="col-md-2">
                            <input type="text" readonly class="form-control js-example-responsive" name="total_sumber"
                                id="total_sumber">
                        </div>
                        <label for="realisasi_sumber"
                            class="col-md-1 col-form-label js-example-responsive">Realisasi</label>
                        <div class="col-md-3">
                            <input type="text" readonly class="form-control js-example-responsive"
                        ...
                        <div class="col-md-3">
                            <input type="text" readonly class="form-control js-example-responsive"
                                style="background-color:#B0E0E6;" name="sisa_sumber" id="sisa_sumber">
                        </div>
                    </div>

                    <!-- Status Anggaran dan Anggaran Kas -->
                    <div class="mb-3 row">
                        <label for="status_anggaran" class="col-md-2 col-form-label js-example-responsive">Status
                            Anggaran</label>
                        <div class="col-md-2">
                            <input type="text" readonly class="form-control js-example-responsive"
                                name="status_anggaran" id="status_anggaran">
                        </div>
                        <label for="status_angkas" class="col-md-2 col-form-label js-example-responsive">Status Anggaran
                            Kas</label>
                        <div class="col-md-2">
                            <input type="text" readonly class="form-control js-example-responsive"
                                name="status_angkas" id="status_angkas">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control js-example-responsive" id="input_nilai"
                                name="input_nilai" data-type="currency">
                        </div>
                    </div>
                    <div class=" mb-4 row text-center">
                        <div class="col-md-12">
                            <button type="button" class="btn btn-success" id="tambahrincianrekening"
                                style="margin-right:4px"><i class="bx bx-plus-circle"></i> Tambah Rincian Rekening
                            </button>
                        </div>
                    </div>
                    <div class="row">
...
@section('js')
    <script>
        ...
        function deleteData(kd_rek6, nm_rek6, kd_sumber, nilai_rincian) {
            ...
            let hapus = confirm('Yakin Ingin Menghapus Data, Rekening : ' + kd_rek6 + '  Nilai :  ' + new Intl.NumberFormat(
                    'id-ID', {
                        minimumFractionDigits: 2
                    }).format(nilai_rincian) +
                ' ?');
