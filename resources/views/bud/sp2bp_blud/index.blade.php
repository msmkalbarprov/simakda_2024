...
@section('title', 'SP2BP BLUD | SIMAKDA')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-rep-plugin">
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            <table id="sp2bp_blud" class="table" style="width: 100%">
                                <thead>
                                    <tr>
                                        <th style="width: 25px;text-align:center">No.</th>
                                        <th style="width: 50px;text-align:center">No SP2BP</th>
                                        <th style="width: 100px;text-align:center">Tanggal SP2BP</th>
                                        <th style="width: 50px;text-align:center">No SP3B</th>
...
@endsection
@section('js')
    @include('bud.sp2bp_blud.js.index')
@endsection
