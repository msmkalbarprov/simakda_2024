...
<body>
    <table style="border-collapse:collapse;font-family: Open Sans; font-size:16px" width="100%" align="center"
        ...
        <tr>
            <td align="center" style="font-size:16px" width="93%">
                <h2> KONFIRMASI TRANSFER KE DAERAH</h2>
            </td>
        </tr>
        <tr>
    ...
    <table style="width: 100%;border-collapse:collapse;font-family: Open Sans; font-size:14px" border="1"
        cellpading="2px">
        <thead>
            <tr>
