...
<head>
    ...
    <title>KOREKSI PENGELUARAN</title>
    <style>
        table {
...
<body>
    ...
    <table style="width: 100%">
        <tr>
            <td style="text-align: center"><b>LAPORAN KOREKSI PENGELUARAN TAHUN ANGGARAN {{ tahun_anggaran() }}</b></td>
        </tr>
    </table>
        ...
        <tbody>
            ...
            @foreach ($data_koreksi as $data)
                ...
                <tr>
                    ...
                    <td style="text-align: center">{{ $data->no_sp2d }}</td>
            ...
            <tr>
                <td class="bawah"></td>
                <td colspan="3" class="bawah kiri">Jumlah Tanggal
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                    @if ($pilihan == '1')
                        {{ tanggal($tanggal) }}
                    @elseif ($pilihan == '2')
            ...
            <tr>
                <td class="bawah"></td>
                <td colspan="3" class="bawah kiri">Jumlah Sampai Tanggal :
                    @if ($pilihan == '1')
                        @php
            ...
            <tr>
                <td></td>
                <td colspan="3" class="kiri">Jumlah s.d
                    Tanggal&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                    @if ($pilihan == '1')
                        {{ tanggal($tanggal) }}
                    @elseif ($pilihan == '2')
