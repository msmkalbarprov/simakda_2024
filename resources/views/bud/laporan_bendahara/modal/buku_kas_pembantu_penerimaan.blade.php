    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><label for="labelcetak" id="labelcetak">BUKU KAS PEMBANTU PENERIMAAN</label></h5>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 row">
                    <div class="col-md-12 text-center">
                        <button type="button" class="btn btn-danger btn-md cetak_pembantu_penerimaan" data-jenis="pdf">
                            PDF</button>
