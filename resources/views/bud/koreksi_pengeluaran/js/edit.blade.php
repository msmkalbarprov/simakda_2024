<script>
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(index, data) {
                    if (no_sp2d_sementara == data.no_sp2d) {
                        $('#no_sp2d').append(
                            `<option value="${data.no_sp2d}"  selected>${data.no_sp2d}</option>`
                        );
                    } else {
                        $('#no_sp2d').append(
        ...
        $.ajax({
            url: "{{ route('koreksi_pengeluaran.jenis') }}",
            type: "POST",
            dataType: 'json',
            data: {
                kd_skpd: document.getElementById('kd_skpd').value,
            ...
            success: function(data) {
                ...
                $('#jenis').append(
                    `<option value="" disabled selected>Silahkan Pilih</option>`);
                $.each(data, function(index, data) {
                    if (jenis_sementara == data.kd_rek6) {
                        $('#jenis').append(
        ...
        $('#simpan').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('koreksi_pengeluaran.simpan_edit') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    data: data
                ...
                success: function(response) {
                    if (response.message == '1') {
                        ...
                        window.location.href =
                            "{{ route('koreksi_pengeluaran.index') }}";
                    } else {
