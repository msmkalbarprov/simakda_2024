        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{-- Jenis dan Nama Jenis --}}
                    <div class="mb-3 row">
                        <label for="jenis" class="col-md-2 col-form-label">Akun</label>
                        <div class="col-md-4">
                        ...
                        <label for="nama_jenis" class="col-md-2 col-form-label">Nama Akun</label>
                        <div class="col-md-4">
...
@endsection
@section('js')
    @include('bud.koreksi_pengeluaran.js.create');
@endsection
