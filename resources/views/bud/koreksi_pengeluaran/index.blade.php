        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    List Data Koreksi Pengeluaran
                    <a href="{{ route('koreksi_pengeluaran.tambah') }}" class="btn btn-primary" style="float: right;">Tambah</a>
                </div>
                <div class="card-body">
                    <div class="table-rep-plugin">
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            <table id="koreksi_pengeluaran" class="table" style="width: 100%">
                                <thead>
                                    <tr>
...
@endsection
@section('js')
    @include('bud.koreksi_pengeluaran.js.index')
@endsection
