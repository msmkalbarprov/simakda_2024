...
<body>
    ...
    <table style="border-collapse:collapse;font-family: Arial; font-size:12px" width="100%" align="center"
        ...
        <tr>
            ...
            <td colspan="3" align="center" style="font-size:14px"><b>Laporan Realisasi Anggaran Tahun Anggaran
                    {{ $thn_ang }}</b></td>
        </tr>
        <tr>
    ...
    <table style="border-collapse:collapse;font-family: Arial; font-size:12px" width="100%" align="center"
        ...
        <thead>
            <tr>
                ...
                <td colspan="2" bgcolor="#CCCCCC" width="30%" align="center"><b>REALISASI {{ $thn_ang }}</b>
                </td>
        ...
        @foreach ($sql as $row4)
            ...
            @elseif ($bold == 5)
                <tr>
                    ...
                    <td style="vertical-align:top;border-top: solid 1px black;border-bottom: none;" width="20%"
                        align="right">{{ $x }}{{ rupiah($nilai) }}{{ $z }}</td>
                    <td style="vertical-align:top;border-top: solid 1px black;border-bottom: none;" width="20%"
                        align="right"></td>
                    <td style="vertical-align:top;border-top: solid 1px black;border-bottom: none;" width="15%"
                        align="right"></td>
