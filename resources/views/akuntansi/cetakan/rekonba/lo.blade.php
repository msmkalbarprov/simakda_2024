...
{{-- <body> --}}
    ...
    <table style="border-collapse:collapse;font-family: Arial; font-size:12px" width="100%" align="center" border="0" cellspacing="0" cellpadding="2">
        <tr>
            ...
            <td colspan="3" align="center" style="font-size:14px"><b>Laporan Operasional Tahun Anggaran $thn_ang</b></td>
        </tr>
        <tr>
    ...
    <table style="border-collapse:collapse;font-family: Arial; font-size:12px" width="100%" align="center" border="1" cellspacing="0" cellpadding="4">
        ...
        @php
            ...
            $nilainya = collect(DB::select("select isnull(sum(nilai_a-nilai_b),0) nilai
                    ...
                    and tgl_voucher between '$periode1' and '$periode2' and left(b.kd_skpd,len('$kd_skpd'))='$kd_skpd') a "))->first();
            ...
            $nilainya_lalu = collect(DB::select("select sum(nilai_a-nilai_b) nilai
                    ...
                    SELECT 0  nilai_a,SUM($cetak_k) nilai_b FROM trdju_pkd a inner join trhju_pkd b on a.no_voucher=b.no_voucher and a.kd_unit=b.kd_skpd 
                    WHERE (left(kd_rek6,1) in ($k1) or left(kd_rek6,2) in ($k2)) 
                    and year(tgl_voucher)=$thn_ang1 and left(b.kd_skpd,len('$kd_skpd'))='$kd_skpd') a "))->first();   
