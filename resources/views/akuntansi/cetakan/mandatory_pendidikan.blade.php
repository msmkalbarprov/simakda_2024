...
<head>
    ...
    <title>MANDATORY PENDIDIKAN</title>
    <style>
        table {
...
<body onload="window.print()">
    ...
    <table style="border-collapse:collapse;" width="100%" align="center" border="0" cellspacing="0" cellpadding="4">
        ...
        <TR>
            <td align="center"><strong>REKAPITULASI REALISASI ANGGARAN BELANJA MANDATORY SPENDING-BIDANG PENDIDIKAN TA
...
realisasi",
                                ...
                                foreach ($nilai2 as $res1) {
                                    $anggarann1 = $res1->anggaran;
                                    $realisasii1 = $res1->realisasi;
                                    if ($anggarann1 == 0) {
                                        $persenn1 = 0;
                                    } else {
...
realisasi",
                            ...
                            @endphp
                            @foreach ($nilair as $item3)
                                @php
                                    $uraiann = $item3->uraian;
                                    $anggaran = $item3->anggaran;
                                    $realisasi = $item3->realisasi;
                                    if ($anggaran == 0) {
                                        $persen = 0;
                                    } else {
                                        $persen = ($realisasi / $anggaran) * 100;
...
anggaran,
            ...
            <tr>
                ...
                <td><b>Anggaran Fungsi Pendidikan (a+b)</b>
                </td>
            ...
            @php
                $rasio_ang = ($anggaran2 / $anggaran3) * 100;
                $rasio_real = ($realisasi2 / $realisasi3) * 100;
                $rasio_persen = ($persen2 / $persen3) * 100;
            @endphp
            <tr>
                <td style="text-align: center"><b></b></td>
                <td><b>Rasio anggaran pendidikan (2:3) x 100%</b>
                </td>
