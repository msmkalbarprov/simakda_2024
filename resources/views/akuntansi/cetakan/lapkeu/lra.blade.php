...
{{-- <body> --}}
    ...
    <table style="border-collapse:collapse;" width="100%" align="center" border="0" cellspacing="0" cellpadding="4">
            ...
            @else
            <TR>
                <td align="center"><strong>UNTUK PERIODE {{$tgl_format_oyoy(tanggal1)}} SAMPAI DENGAN {{$tgl_format_oyoy(tanggal1)}} </strong></td>
            </TR>
            @endif
    ...
    <table style="font-size:11px;border-collapse:collapse;" width="100%" align="center" border="1" cellspacing="0" cellpadding="4">
        <thead>                       
            <tr>
        ...
        <tr>
            <td style="vertical-align:top;border-top: none;border-bottom: none;" width="5%" align="center">&nbsp;</td><td style="vertical-align:top;border-top: none;border-bottom: none;" width="40%">&nbsp;</td>
        ...
        @endphp
            ...
            @elseif ($bold == 1)
                <tr>
                    ...
                    <td style="vertical-align:top;border-top: solid 1px black;border-bottom: none;" width="20%" align="right">{{rupiah($anggaran)}}</td>
                    <td style="vertical-align:top;border-top: solid 1px black;border-bottom: none;" width="20%" align="right">{{rupiah($nilai)}}</td>
                    <td style="vertical-align:top;border-top: solid 1px black;border-bottom: none;" width="15%" align="right">{{$sela}}{{rupiah($selisih1)}}{{$selb}}</td>
                    <td style="vertical-align:top;border-top: solid 1px black;border-bottom: none;" width="10%" align="right">{{rupiah($persen)}}</td>
                </tr>
            ...
            @elseif ($bold == 5)
                <tr>
                    <td style="vertical-align:top;border-top: solid 1px black;border-bottom: none;" width="5%" align="center">{{$no}}x</td>                                     
                    <td style="vertical-align:top;border-top: solid 1px black;border-bottom: none;" width="40%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$nama}}</td>
                    <td style="vertical-align:top;border-top: solid 1px black;border-bottom: none;" width="20%" align="right">{{$a}}{{rupiah($ang_surplus)}}{{$b}}</td>
                    <td style="vertical-align:top;border-top: solid 1px black;border-bottom: none;" width="20%" align="right">{{$c}}{{rupiah($nil_surplus)}}{{$d}}</td>
                    <td style="vertical-align:top;border-top: solid 1px black;border-bottom: none;" width="15%" align="right">{{$i}}{{rupiah($sisa_surplus)}}{{$j}}</td>
                    <td style="vertical-align:top;border-top: solid 1px black;border-bottom: none;" width="10%" align="right">{{rupiah($persen_surplus)}}</td>
                </tr>
            @else
                <tr>
