...
@include('akuntansi.cetakan.calk.bab3.lo_beban.modal_edit_bab3_lo_beban')
@endsection
@section('js')
    <script>
    $(document).ready(function() {
        ...
        let data=$('#table_edit').DataTable({
            ...
            lengthMenu: [10, 20],
            ajax: {
                "url": "{{ route('calk.load_calkbab3_lo_beban') }}",
                "type": "POST",
    ...
    function edit(kd_skpd, nm_skpd, kd_rek, nm_rek, nilai) {
        ...
        $('#modal_edit_bab3_lo_beban').modal('show');
    }
    ...
    function simpan(){
        ...
        $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: "{{ route('calk.simpan_calkbab3_lo_beban') }}",
                data: ({tabel:'nilai_beban_calk',kd_skpd:kd_skpd,kd_rek:kd_rek,nm_rek:nm_rek,nilai:nilai}),
                dataType:"json",
