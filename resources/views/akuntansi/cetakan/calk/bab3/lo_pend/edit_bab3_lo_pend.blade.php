...
@section('title', 'CALK EDIT BAB III LO PENDAPATAN | SIMAKDA')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    Edit Uraian Bab III LO PENDAPATAN
                </div>
...
@include('akuntansi.cetakan.calk.bab3.lo_pend.modal_edit_bab3_lo_pend')
@endsection
@section('js')
    <script>
    $(document).ready(function() {
        ...
        let data=$('#table_edit').DataTable({
            ...
            lengthMenu: [10, 20],
            ajax: {
                "url": "{{ route('calk.load_calkbab3_lo_pend') }}",
                "type": "POST",
    ...
    function edit(kd_skpd, nm_skpd, kd_rek, nm_rek, nilai) {
        $('#kd_skpd').val(kd_skpd);
        $('#nm_skpd').val(nm_skpd);
        $('#kd_rek').val(kd_rek);
        $('#nm_rek').val(nm_rek);
        ...
        $('#modal_edit_bab3_lo_pend').modal('show');
    }
    ...
    function simpan(){
        ...
        $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: "{{ route('calk.simpan_calkbab3_lo_pend') }}",
                data: ({tabel:'nilai_pend_lo_calk',kd_skpd:kd_skpd,kd_rek:kd_rek,nm_rek:nm_rek,nilai:nilai}),
                dataType:"json",
