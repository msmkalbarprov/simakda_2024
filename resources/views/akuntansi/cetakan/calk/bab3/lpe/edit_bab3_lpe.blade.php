...
@include('akuntansi.cetakan.calk.bab3.lpe.modal_edit_bab3_lpe')
@endsection
@section('js')
    <script>
    $(document).ready(function() {
        ...
        let data=$('#table_edit').DataTable({
            ...
            lengthMenu: [10, 20],
            ajax: {
                "url": "{{ route('calk.load_calkbab3_lpe') }}",
                "type": "POST",
    ...
    function edit(kd_skpd, nm_skpd, kd_rek, nm_rek, ket) {
        ...
        $('#modal_edit_bab3_lpe').modal('show');
    }
    ...
    function simpan(){
        ...
        $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: "{{ route('calk.simpan_calkbab3_lpe') }}",
