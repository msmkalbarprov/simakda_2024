...
<div id="modal_edit_bab3_lra_pend" class="modal" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title"><label  >Edit Uraian Bab III LRA Pendapatan</label></h5>
            ...
            <tr>
                <td width="30%">Uraian Target</td>
                <td width="1%">:</td>
                <td>
                    <div class="col-md-10">
                        <textarea class="form-control" style="width: 100%" id="ket1" name="ket1"></textarea>
                    </div>
                </td>  
            </tr>
            <tr>
                <td width="30%">Uraian Realisasi</td>
                <td width="1%">:</td>
                <td>
                    <div class="col-md-10">
                        <textarea class="form-control" style="width: 100%" id="ket2" name="ket2"></textarea>
                    </div>
                </td>  
            </tr>
            <tr>
