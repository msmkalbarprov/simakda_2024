...
@section('title', 'CALK EDIT BAB III LRA PEND | SIMAKDA')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    Edit Uraian Bab III LRA PENDAPATAN
                            ...
                            <table id="table_edit" class="table" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 50px;text-align:center">Uraian Target</th>
                                        <th style="width: 50px;text-align:center">Uraian realisasi</th>
...
@include('akuntansi.cetakan.calk.bab3.lra_pend.modal_edit_bab3_lra_pend')
@endsection
@section('js')
    <script>
    $(document).ready(function() {
        ...
        let data=$('#table_edit').DataTable({
            ...
            lengthMenu: [10, 20],
            ajax: {
                "url": "{{ route('calk.load_calkbab3_lra_pend') }}",
                "type": "POST",
    ...
    function edit(kd_skpd, nm_skpd, kd_rek, nm_rek, ket1, ket2) {
        $('#kd_skpd').val(kd_skpd);
        $('#nm_skpd').val(nm_skpd);
        $('#kd_rek').val(kd_rek);
        $('#nm_rek').val(nm_rek);
        ...
        $('#modal_edit_bab3_lra_pend').modal('show');
    }
    ...
    function simpan(){
        ...
        $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: "{{ route('calk.simpan_calkbab3_lra_pend') }}",
                data: ({tabel:'lamp_calk_bab3_lra_pend',kd_skpd:kd_skpd,kd_rek:kd_rek,nm_rek:nm_rek,ket1:ket1,ket2:ket2}),
                dataType:"json",
