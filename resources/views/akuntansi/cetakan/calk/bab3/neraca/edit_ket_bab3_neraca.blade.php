        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    Edit Uraian Bab III KETERANGAN NERACA
...
@include('akuntansi.cetakan.calk.bab3.neraca.modal_edit_bab3_neraca_ket')
@endsection
@section('js')
    <script>
    $(document).ready(function() {
        ...
        let data=$('#table_edit').DataTable({
            ...
            lengthMenu: [10, 20],
            ajax: {
                "url": "{{ route('calk.load_calkbab3_neraca_ket') }}",
                "type": "POST",
    ...
    function edit(kd_skpd, nm_skpd, kd_rek, nm_rek, ket) {
        $('#kd_skpd').val(kd_skpd);
        $('#nm_skpd').val(nm_skpd);
        $('#kd_rek').val(kd_rek);
        $('#nm_rek').val(nm_rek);
        ...
        $('#modal_edit_bab3_neraca_ket').modal('show');
    }
    ...
    function simpan(){
        ...
        $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: "{{ route('calk.simpan_calkbab3_neraca_ket') }}",
                data: ({tabel:'isi_neraca_calk',kd_skpd:kd_skpd,kd_rek:kd_rek,nm_rek:nm_rek,ket:ket}),
                dataType:"json",
