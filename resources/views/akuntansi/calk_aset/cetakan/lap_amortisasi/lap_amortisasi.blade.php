...
<body>
    <TABLE style="border-collapse:collapse" width="100%" border="0" cellspacing="0" cellpadding="1" align=center>
        ...
        <tr></tr>
        <TR>
            <TD colspan="7" align="center" >Aset Tidak Berwujud</TD>
        </TR>
    </TABLE><br/>
    <table style="border-collapse:collapse;" width="100%" align="center" border="1" cellspacing="0" cellpadding="0">
        <thead>
            <tr>
                ...
                <td width="10%" align="center" bgcolor="#CCCCCC" style="font-size:12px">Amortisasi Tahun {{$thn_ang}}</td>
        ...
        @foreach($query as $row)
            @php
                ...
                $tot_amortisasi = $tot_amortisasi+$amortisasi;
                $tot_sal = $tot_sal+$sal;
            @endphp
            <tr>
                ...
                <td align="right" valign="top" style="font-size:12px">{{$amortisasi < 0 ? '(' . rupiah($amortisasi * -1) . ')' : rupiah($amortisasi) }}</td> 
        ...
        <tr>
            ...
            <td align="right" valign="top" style="font-size:12px">{{$tot_amortisasi < 0 ? '(' . rupiah($tot_amortisasi * -1) . ')' : rupiah($tot_amortisasi) }}</td> 
