...
{{-- lpsal --}}
<div id="modal_cetak_lpsal" class="modal" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><label for="labelcetak_semester" id="labelcetak_semester"></label></h5>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 row">
                    ...
                    {{-- BULAN --}}
                        ...
                        <div id="baris_bulan" class="col-md-6">
                            <label for="bulan_lpsal" class="form-label">Bulan</label>
                            <select name="bulan_lpsal" class="form-control select_lpsal" id="bulan_lpsal">
                                <option value="">Silahkan Pilih</option>
                                <option value="1">Januari</option>
                                <option value="2">Februari</option>
                                <option value="3">Maret</option>
