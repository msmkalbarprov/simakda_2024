...
<div id="modal_cetak_lralo" class="modal" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><label for="labelcetak_semester" id="labelcetak_semester"></label></h5>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 row">
                    <div class="col-md-6">
                        <label for="kd_skpd_lralo" class="form-label">Pilih</label><br>
                        <div class=" form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pilihan_lralo" id="pilihan0"
                                value="keseluruhan">
                            <label class="form-check-label" for="pilihan">Keseluruhan</label>
                        </div>
                        <div class=" form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pilihan_lralo" id="pilihan1"
                                value="skpd">
                            <label class="form-check-label" for="pilihan">SKPD</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pilihan_lralo" id="pilihan2"
                                value="unit">
                            <label class="form-check-label" for="pilihan">Unit</label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div id="baris_skpd_lralo">
                            <label for="kd_skpd_lralo" class="form-label">Kode SKPD</label>
                            <select class="form-control select_lralo  @error('kd_skpd_lralo') is-invalid @enderror"
                                style=" width: 100%;" id="kd_skpd_lralo" name="kd_skpd_lralo">
                                <option value="" disabled selected>Silahkan Pilih</option>
                            </select>
                            @error('kd_skpd_lralo')
                                <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="mb-3 row">
                    <div class="col-md-6">
                        <label for="kd_skpd_lralo" class="form-label">Pilih</label><br>
                        <div class=" form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pilihanperiode_lralo" id="pilihan1_lralo"
                                value="periode">
                            <label class="form-check-label" for="pilihan">Periode</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pilihanperiode_lralo" id="pilihan2_lralo"
                                value="bulan">
                            <label class="form-check-label" for="pilihan">Bulan</label>
                        </div>
                    </div>
                    {{-- PERIODE /BULAN --}}
                    <div id="baris_periode1_lralo" class="col-md-3">
                        <label for="periode1" class="form-label">Periode</label>
                        <input type="date" id="tanggal1_lralo" name="tanggal1_lralo" class="form-control">
                    </div>
                    <div id="baris_periode2_lralo" class="col-md-3">
                        <label for="periode2" class="form-label">&nbsp;</label>
                        <input type="date" id="tanggal2_lralo" name="tanggal2_lralo" class="form-control">

                    </div>
                    <div id="baris_bulan_lralo" class="col-md-6">
                        <label for="bulan" class="form-label">Bulan</label>
                        <select name="bulan_lralo" class="form-control select_lralo" id="bulan_lralo">
                            <option value="">Silahkan Pilih</option>
                            <option value="1">Januari</option>
                            <option value="2">Februari</option>
                            <option value="3">Maret</option>
