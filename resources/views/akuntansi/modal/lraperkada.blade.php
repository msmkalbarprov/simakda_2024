...
<div id="modal_cetak_lamp2" class="modal" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><label for="labelcetak_semester" id="labelcetak_semester"></label></h5>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 row">
                    <div class="col-md-6">
                        <label for="kd_skpd_lamp2" class="form-label">Pilih</label><br>
                        <div class=" form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pilih_lamp2" id="pilihan1"
                                value="skpd">
                            <label class="form-check-label" for="pilihan">SKPD</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pilih_lamp2" id="pilihan2"
                                value="unit">
                            <label class="form-check-label" for="pilihan">Unit</label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6" >
                        <div id="baris_skpd">
                            <label for="kd_skpd_lamp2" class="form-label">Kode SKPD</label>
                            <select class="form-control select_lamp2  @error('kd_skpd_lamp2') is-invalid @enderror"
                                style=" width: 100%;" id="kd_skpd_lamp2" name="kd_skpd_lamp2">
                                <option value="" disabled selected>Silahkan Pilih</option>
                            </select>
                            @error('kd_skpd_lamp2')
                                <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="mb-3 row">
                    ...
                    {{-- PERIODE /BULAN --}}
                        ...
                        <div class="col-md-6">
                            <label for="bulan_lamp2" class="form-label">Bulan</label>
                            <select name="bulan_lamp2" class="form-control select_lamp2" id="bulan_lamp2">
                                <option value="">Silahkan Pilih</option>
                                <option value="1">Januari</option>
                                <option value="2">Februari</option>
                                <option value="3">Maret</option>
                        ...
                        <div class="col-md-6">
                        <label for="jns_anggaran_lamp2" class="form-label">Jenis Anggaran</label>
                        <select name="jns_anggaran_lamp2" class="form-control select_lamp2" id="jns_anggaran_lamp2">
                            <option value="" selected disabled>Silahkan Pilih</option>
                            @foreach ($jns_anggaran as $anggaran)
                                <option value="{{ $anggaran->kode }}" data-nama="{{ $anggaran->nama }}">
                                    {{ $anggaran->kode }} | {{ $anggaran->nama }}
                ...
                <div class="mb-3 row">
                    <div class="col-md-6">
                        <label for="jns_rincian" class="form-label">Jenis</label>
                        <select class="form-control select_lamp2" id="jns_rincian" name="jns_rincian">
                            <option value="" disabled selected>Silahkan Pilih</option>
