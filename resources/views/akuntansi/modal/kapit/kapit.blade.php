{{-- Cetak Kapit --}}
<div id="modal_cetak_kapit" class="modal" role="dialog" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 row">
                    <div class="col-md-6">
                        ...
                        <select class="form-control select_kapit @error('kd_skpd') is-invalid @enderror"
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="cetakan" class="form-control select_kapit" id="cetakan">
                            <option value="1">Cetak Biasa</option>
                            <option value="2">Cetak Layar Dengan Kode Barang</option>
                        </select>
                    </div>
                </div>
                <div class="mb-3 row">
