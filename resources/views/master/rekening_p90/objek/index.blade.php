...
@section('title', 'REKENING OBJEK | SIMAKDA')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-rep-plugin">
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            <table id="objek" class="table" style="width: 100%">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Kode Objek</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">REKENING OBJEK</h5>
                        ...
                        <div class="col-md-8">
                            <select name="kode_akun" id="kode_akun" class="form-control select2-modal">
                                ...
                                @foreach ($daftar_akun as $akun)
                                    <option value="{{ $akun->kd_rek3 }}">{{ $akun->kd_rek3 }} - {{ $akun->nm_rek3 }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            let tabel_objek = $('#objek').DataTable({
                responsive: true,
                ordering: false,
                serverSide: true,
                processing: true,
