...
@section('title', 'REKENING RINCI OBJEK | SIMAKDA')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-rep-plugin">
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            <table id="rinci_objek" class="table" style="width: 100%">
                                <thead>
                                    <tr>
                                        <th>No.</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">REKENING RINCIAN OBJEK</h5>
                        ...
                        <div class="col-md-8">
                            <select name="kode_akun" id="kode_akun" class="form-control select2-modal">
                                ...
                                @foreach ($daftar_akun as $akun)
                                    <option value="{{ $akun->kd_rek4 }}">{{ $akun->kd_rek4 }} - {{ $akun->nm_rek4 }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            let tabel_objek = $('#rinci_objek').DataTable({
                responsive: true,
                ordering: false,
                serverSide: true,
                processing: true,
        ...
        function deleteData(id) {
            ...
            let tabel = $('#rinci_objek').DataTable();
            if (tanya == true) {
                $.ajax({
                    url: "{{ route('rinci_objek.hapus') }}",
                    type: "POST",
                    dataType: 'json',
                    data: {
                        kode_rekening: id,
