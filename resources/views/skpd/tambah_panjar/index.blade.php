...
@section('title', 'Tambah Panjar | SIMAKDA')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('tambahpanjar.tambah') }}" class="btn btn-primary" style="float: right;">Tambah</a>
                </div>
                <div class="card-body">
                    <div class="table-rep-plugin">
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            <table id="tambahpanjar" class="table" style="width: 100%">
                                <thead>
                                    <tr>
...
@endsection
@section('js')
    @include('skpd.tambah_panjar.js.index')
@endsection
