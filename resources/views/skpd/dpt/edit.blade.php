...
@section('title', 'EDIT DPT | SIMAKDA')
@section('content')
    <div class="row">
        {{-- Input form --}}
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="no_dpr" readonly value="{{ $dpt->no_dpr }}">
                        </div>
                    </div>
                    {{-- NILAI --}}
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="nilai" readonly
                                value="{{ rupiah($dpt->total) }}">
                        </div>
                    </div>
                    <!-- SIMPAN -->
                    <div style="float: right;">
                        <button id="simpan" class="btn btn-primary btn-md"
                            {{ $dpt->status == '1' ? 'hidden' : '' }}>Simpan</button>
