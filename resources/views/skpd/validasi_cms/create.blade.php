...
@section('title', 'Tambah Validasi CMS | SIMAKDA')
@section('content')
    <div class="row">
        {{-- Input form --}}
        <div class="col-12">
                ...
                <div class="card-body">
                            ...
                            <select name="data_transaksi" id="data_transaksi" class="form-control select2-multiple">
                                ...
                                {{-- @foreach ($daftar_transaksi as $data)
                                    <option value="{{ $data->no_voucher }}" data-tgl="{{ $data->tgl_voucher }}"
                                        ...
                                        data-no_upload="{{ $data->no_upload }}" data-total="{{ $data->total }}"
                                        data-tot_pot="{{ $data->tot_pot }}" data-rekening_awal="{{ $data->rekening_awal }}"
                    ...
                    <div style="float: right;">
                        <button id="proses_upload" class="btn btn-primary btn-md"><i class="uil-search-alt"></i>Proses
                            Validasi</button>
                        <a href="{{ route('skpd.validasi_cms.index') }}" class="btn btn-warning btn-md">Kembali</a>
                    </div>
                </div>
...
@endsection
@section('js')
    @include('skpd.validasi_cms.js.create');
@endsection
