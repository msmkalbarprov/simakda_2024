...
@section('title', 'Ubah Pemberian Panjar CMS | SIMAKDA')
@section('content')
    <div class="row">
        {{-- Input form --}}
        <div class="col-12">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" id="no_simpan" name="no_simpan"
                                placeholder="Tidak perlu diisi atau diedit" value="{{ $panjar->no_panjar }}" required
                                readonly>
                            ...
                            <select class="form-control select2-multiple" style="width: 100%" id="rekening"
                                ...
                                @foreach ($daftar_rekening_bank as $bank)
                                    <option value="{{ $bank->rekening }}"
                                        {{ $panjar->rekening_awal == $bank->rekening ? 'selected' : '' }}>
                            ...
                            <select class="form-control select2-multiple" style="width: 100%" id="kd_sub_kegiatan"
                                ...
                                @foreach ($daftar_kegiatan as $kegiatan)
                                    <option value="{{ $kegiatan->kd_sub_kegiatan }}"
                                        ...
                                        {{ $panjar->kd_sub_kegiatan == $kegiatan->kd_sub_kegiatan ? 'selected' : '' }}>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            ...
                            <input class="form-control" type="text" id="nilai_simpan" name="nilai_simpan" required
                                hidden data-type="currency" style="text-align: right"
                                value="{{ rupiah($panjar->nilai) }}">
                        </div>
                    </div>
                    {{-- Pajak --}}
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" id="pajak" name="pajak" required readonly
                                style="text-align: right" value="{{ $panjar->nilai - $total_transfer }}">
                        </div>
                    </div>
                    {{-- Keterangan --}}
                    <div class="mb-2 row">
                    ...
                    <div class="mb-3 row" style="float: right;">
                        <div class="col-md-12" style="text-align: center">
                            <button id="simpan" class="btn btn-primary btn-md"
                                {{ $panjar->status_upload == '1' ? 'hidden' : '' }}>Simpan</button>
...
@endsection
@section('js')
    @include('skpd.pemberian_panjar_cms.js.edit');
@endsection
