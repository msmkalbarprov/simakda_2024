        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    List Data Pemberian Panjar CMS
                    <a href="{{ route('pemberian_panjarcms.tambah') }}" class="btn btn-primary"
                        style="float: right;">Tambah</a>
                </div>
                <div class="card-body">
                    <div class="table-rep-plugin">
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            <table id="pemberian_panjarcms" class="table" style="width: 100%">
                                <thead>
                                    <tr>
...
@endsection
@section('js')
    @include('skpd.pemberian_panjar_cms.js.index')
@endsection
