                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2-multiple" style="width: 100%" id="jenis_beban"
                                name="jenis_beban">
                                <option value="" disabled selected>Silahkan Pilih</option>
                                <option value="4">BOS PPKD</option>
                                <option value="6">BOS SKPD</option>
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2-multiple" style="width: 100%" id="jenis_bos"
                                name="jenis_bos">
                                <option value="" disabled selected>Silahkan Pilih</option>
                                <option value="reguler">Bos Reguler</option>
                                <option value="hibah">Bos Hibah</option>
                                </option>
                            </select>
                        </div>
                    </div>
...
@endsection
@section('js')
    @include('skpd.transaksi_bos.js.create');
@endsection
