...
@section('title', 'Terima Potongan Pajak KKPD | SIMAKDA')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('skpd.transaksi_kkpd.create_potongan') }}" class="btn btn-primary"
...
@endsection
@section('js')
    @include('skpd.potongan_kkpd.js.index')
@endsection
