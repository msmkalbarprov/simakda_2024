                    ...
                    <div class="mb-2 mt-2 row">
                        ...
                        <div class="col-md-4">
                            <input type="text" style="text-align: right" readonly class="form-control"
                                id="total_belanja" name="total_belanja" value="{{ rupiah($cms->total) }}">
                        </div>
                        <div class="col-md-4">
                            <input type="text" style="text-align: right" readonly class="form-control"
                    ...
                    <div class="mb-2 mt-2 row">
                        ...
                        <div class="col-md-4">
                            <input type="text" style="text-align: right" readonly class="form-control"
                                ...
                                value="{{ rupiah($cms->total - $total_transfer) }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    ...
                    <div class="mb-2 mt-2 row">
                        ...
                        <div class="col-md-4">
                            <input type="text" style="text-align: right" readonly class="form-control"
                                id="total_transfer" name="total_transfer" value="{{ rupiah($total_transfer) }}">
                        </div>
                    </div>
                </div>
            </div>
