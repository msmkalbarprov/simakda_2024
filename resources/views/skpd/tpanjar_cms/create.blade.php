...
@section('title', 'Input Data Tambah Panjar CMS | SIMAKDA')
@section('content')
    <div class="row">
        {{-- Input form --}}
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                       <input class="form-control" type="text" id="nilaipanjar" name="nilaipanjar" required readonly>
                        </div>
                    </div>
...
@endsection
@section('js')
    @include('skpd.tpanjar_cms.js.create');
@endsection
