...
@section('title', 'Upload Panjar CMS | SIMAKDA')
@section('content')
    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body" id="card_transaksi">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-7">
                                        <a href="{{ route('upload_panjarcms.create') }}" class="btn btn-primary"
                                        ...
                                        <table id="upload_cms" class="table" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 100px;text-align:center">Tanggal Setor</th>
                                                    ...
                                                    <th style="width: 50px;text-align:center">Nilai Panjar</th>
                                                    <th style="width: 50px;text-align:center">Pajak</th>
                                                    <th style="width: 50px;text-align:center">Bersih</th>
                                        ...
                                        <table id="draft_upload" class="table" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 10px;text-align:center">No. UPL</th>
                                                    <th style="width: 10px;text-align:center">Urut</th>
                                                    <th style="width: 10px;text-align:center">No. Panjar</th>
                                                    <th style="width: 10px;text-align:center">Tanggal Panjar</th>
...
@endsection
@section('js')
    @include('skpd.upload_panjar_cms.js.index')
@endsection
