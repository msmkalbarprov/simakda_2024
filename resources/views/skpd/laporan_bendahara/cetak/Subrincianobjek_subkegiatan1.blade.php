        ...
        <div style="page-break-after:always;">
            ...
            <table style="width: 100%" border="1">
                ...
                <tr>
                    ...
                    <td class="angka"><b>{{ rupiah($lalu_ls) }}</b></td>
                    <td class="angka"><b>{{ rupiah($lalu_up) }}</b></td>
                    <td class="angka"><b>{{ rupiah($lalu_gu) }}</b></td>
                    <td class="angka"><b>{{ rupiah($jml_lalu) }}</b></td>
                </tr>
                <tr>
                    <td colspan="2"><i><b>Jumlah s/d periode ini </i></b></td>
                    <td class="angka"><b>{{ rupiah($tot2) }}</b></td>
                    <td class="angka"><b>{{ rupiah($tot) }}</b></td>
                    <td class="angka"><b>{{ rupiah($tot1) }}</b></td>
