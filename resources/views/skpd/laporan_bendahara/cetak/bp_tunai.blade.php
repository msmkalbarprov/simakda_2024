            ...
            <td align='right' width='15%' style='font-size:12px;border-bottom:solid 1px black;border-top:solid 1px black;'>{{rupiah($saldo_awal)}}</td>            
                ...
                @endphp
                    @foreach ($rincian as $rinci)
                        ...
                        @endphp
                            @php
                            $saldo=$saldo+$total_terima-$rinci->keluar;
                            ...
                            @endphp
                                <tr>
                                  ...
                                  <td align='right' style='font-size:12px;border-bottom:solid 1px black;border-top:solid 1px black'>{{rupiah($rinci->masuk)}}</td>
