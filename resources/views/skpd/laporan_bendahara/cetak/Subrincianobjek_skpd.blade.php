            ...
            @foreach ($headers as $header) 
                <TABLE width="100%" style="font-size:12px;">
                    ...
                    <TR>
                        ...
                        <TD align="left" width="75%" >: {{$header->kd_sub_kegiatan}} - {{cari_nama($header->kd_sub_kegiatan,'ms_sub_kegiatan','kd_sub_kegiatan','nm_sub_kegiatan');}}</TD>
                    </TR>
                    <TR>
                        <TD align="left" width="25%" >Rekening </TD>
                        <TD align="left" width="75%" >: {{$header->kd_rek6}} - {{cari_nama($header->kd_rek6,'ms_rek6','kd_rek6','nm_rek6');}}</TD>
                    </TR>
                </TABLE>
