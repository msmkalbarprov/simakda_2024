...
<body onload="window.print()">
    ...
    <table style='border-collapse:collapse;font-size:12px' width='100%' align='center' border='1' cellspacing='1'
        ...
        <tr>
            <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
            <td align='left' style='font-size:12px' colspan='2'>&ensp;&ensp;&ensp;&ensp;e. PPH Pasal 4 Ayat 2
            </td>
        ...
        <tr>
            ...
            <td align='right' style='font-size:12px'>
                {{ rupiah($trm_dk_gaji_ll + $trm_dk_gaji_ini + $trm_dk_brjs_ll + $trm_dk_brjs_ini + $trm_dk_up_ll + $trm_dk_up_ini) }}
            </td>
            <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
        </tr>
        {{-- Pelimpahan UP/GU --}}
        ...
        <tr>
            ...
            <td align='right' style='font-size:12px'>{{ rupiah($str_pph4ayat2_gaji_ll + $str_pph4ayat2_gaji_ini) }}
            </td>
        ...
        <tr>
            ...
            <td align='right' style='font-size:12px'>
                {{ rupiah($str_dk_up_ll + $str_dk_up_ini + $str_dk_brjs_ll + $str_dk_brjs_ini + $str_dk_gaji_ll + $str_dk_gaji_ini) }}
            </td>
            <td align='left' style='font-size:12px;border-top:hidden;'>&ensp;&ensp;</td>
        </tr>
        {{-- denda keterlambatan --}}
        ...
        <tr>
            ...
            <td align='right' style=' font-size:12px; '>{{ rupiah($tahun_lalu_uyhd + $tahun_lalu_uyhd_ini) }}
            </td>
            <td align='right' style=' font-size:12px; '>{{ rupiah($tahun_lalu_uyhd + $tahun_lalu_uyhd_ini) }}
            </td>
            <td align='left' style=' font-size:12px; border-top:hidden;'>&ensp;&ensp;</td>
        ...
        <tr>
            ...
            <td align='right' style=' font-size:12px; '>
                {{ rupiah($tahun_lalu_uyhd_pjk + $tahun_lalu_uyhd_pjk_ini) }}</td>
            <td align='right' style=' font-size:12px; '>
                {{ rupiah($tahun_lalu_uyhd_pjk + $tahun_lalu_uyhd_pjk_ini) }}</td>
            <td align='left' style=' font-size:12px; border-top:hidden;'>&ensp;&ensp;</td>
        </tr>
        ...
        <tr>
            ...
            <td align='right' style='font-size:12px'>
                {{ rupiah($sub_trm_uptu_lalu - $sub_str_uptu_lalu + $saldo_uyhd->sld_awal + $saldo_uyhd->sld_awalpajak - $tahun_lalu_uyhd - $tahun_lalu_uyhd_pjk) }}
            </td>
            <td align='right' style='font-size:12px'>
