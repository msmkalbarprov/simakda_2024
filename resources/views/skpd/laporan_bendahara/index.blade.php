            ...
            <div class="modal-body">
                ...
                <div class="mb-3 row">
                    <div class="col-md-6">
                        ...
                        <select name="jns_anggaran2" class="form-control select2-modal @error('jns_anggaran2') is-invalid @enderror"
                        style=" width: 100%;" id="jns_anggaran2">
                            <option value="" selected disabled>Silahkan Pilih</option>
                            @foreach ($jns_anggaran2 as $anggaran2)
                                <option value="{{ $anggaran2->kode }}" data-nama="{{ $anggaran2->nama }}">
                                    {{ $anggaran2->kode }} | {{ $anggaran2->nama }}</option>
                            @endforeach
                        </select>
                    </div>
...
<script>
    ...
    function cari_subkegiatan(kd_skpd2,jns_anggaran2) {
        $.ajax({
            ...
            dataType: 'json',
            data: {
                kd_skpd: kd_skpd2,jns_anggaran:jns_anggaran2
            },
            success: function(data) {
                $('#subkegiatan').empty();
                $('#subkegiatan').append(
    ...
    function cari_akunbelanja(kd_skpd2,subkegiatan,jns_anggaran2) {
        $.ajax({
            ...
            dataType: 'json',
            data: {
                kd_skpd: kd_skpd2,jns_anggaran:jns_anggaran2,subkegiatan:subkegiatan
            },
            success: function(data) {
                $('#akunbelanja').empty();
                $('#akunbelanja').append(
