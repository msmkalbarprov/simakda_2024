<script>
    $(document).ready(function() {
        ...
        let data_setor = $('#data_setor').DataTable({
            responsive: true,
            ordering: false,
            serverSide: true,
            processing: true,
            lengthMenu: [5, 10],
            ajax: {
                "url": "{{ route('skpd.simpanan_bank.load_setor') }}",
                "type": "POST",
            },
