...
@section('title', 'Pelimpahan GU KKPD | SIMAKDA')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('pelimpahan_gu_kkpd.tambah') }}" class="btn btn-primary" style="float: right;">Tambah</a>
                </div>
                <div class="card-body">
...
@endsection
@section('js')
    @include('skpd.pelimpahan_gu_kkpd.js.index')
@endsection
