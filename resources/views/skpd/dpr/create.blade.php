...
@section('title', 'TAMBAH DPR | SIMAKDA')
@section('content')
    <div class="row">
        {{-- Input form --}}
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <select name="jenis_belanja" id="jenis_belanja" class="form-control select2-multiple">
                                ...
                                <option value="3">Belanja Barang/Jasa</option>
                            </select>
                        </div>
                    </div>
                    {{-- SKPD DAN NAMA SKPD --}}
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="nm_kkpd" readonly>
                        </div>
                    </div>
                    <!-- SIMPAN -->
