...
@section('title', 'Edit Data Buku Kas Penerimaan | SIMAKDA')
@section('content')
    <div class="row">
        {{-- Input form --}}
        <div class="col-12">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <select class="form-control select2-multiple" style="width: 100%" id="jenis" name="jenis">
                                ...
                                <option value="1" {{ $terima->jenis == '1' ? 'selected' : '' }}> Deposito </option>
                                <option value="2" {{ $terima->jenis == '2' ? 'selected' : '' }}> Penerimaan Non SP2D
                                </option>
                            </select>
                        </div>
                    </div>
...
@endsection
@section('js')
    @include('skpd.penerimaan_non_pendapatan.js.edit');
@endsection
