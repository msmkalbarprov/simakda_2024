...
@section('title', 'Edit Ambil Simpanan Bank Ke Kasben | SIMAKDA')
@section('content')
    <div class="row">
        {{-- Input form --}}
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" id="ketdrop" name="ketdrop" required readonly
                                value="{{ $data_kasben->ketdrop }}">
                        </div>
                    </div>
                    {{-- Keterangan Dana --}}
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" id="ketdana" name="ketdana" required readonly
                                value="{{ rupiah($data_kasben->ketdana) }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <textarea class="form-control" style="width: 100%" id="keterangan" name="keterangan">{{ $data_kasben->keterangan }}</textarea>
                        </div>
                    </div>
