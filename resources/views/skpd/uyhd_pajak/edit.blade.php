...
@section('title', 'Edit UYHD Pajak | SIMAKDA')
@section('content')
    <div class="row">
        {{-- Input form --}}
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2-multiple" style="width: 100%" id="beban" name="beban">
                                ...
                                <option value="7" {{ $uyhd_pajak->jns_beban == 7 ? 'selected' : '' }}>Pajak</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2-multiple" style="width: 100%" id="pembayaran"
                                name="pembayaran">
                                <option value="" disabled selected>Silahkan Pilih</option>
                                <option value="TUNAI" {{ $uyhd_pajak->pay == 'TUNAI' ? 'selected' : '' }}> TUNAI</option>
                                <option value="BANK" {{ $uyhd_pajak->pay == 'BANK' ? 'selected' : '' }}> BANK</option>
                            </select>
                        </div>
                    </div>
                            ...
                            <select class="form-control select2-multiple" style="width: 100%" id="kd_rek6" name="kd_rek6">
                                ...
                                @foreach ($rekening as $rek)
                                    <option value="{{ $rek->kd_rek6 }}" data-nama="{{ $rek->nm_rek6 }}"
                                        {{ $uyhd_pajak->kd_rek6 == $rek->kd_rek6 ? 'selected' : '' }}>{{ $rek->kd_rek6 }}
                                        | {{ $rek->nm_rek6 }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <textarea class="form-control" style="width: 100%" id="keterangan" name="keterangan">{{ $uyhd_pajak->KET }}</textarea>
                        </div>
                    </div>
                    {{-- Nilai --}}
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="nilai" id="nilai"
                                ...
                                value="{{ $uyhd_pajak->nilai }}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <div class="col-md-12">
                            <input type="checkbox" id="tahun_lalu" {{ $uyhd_pajak->thnlalu == 1 ? 'checked' : '' }}>
...
@endsection
@section('js')
    @include('skpd.uyhd_pajak.js.edit');
@endsection
