...
<script>
    $(document).ready(function() {
        ...
        let data_awal = $('#upload_cms').DataTable({
            ...
            ajax: {
                "url": "{{ route('upload_kkpd.load_data') }}",
                "type": "POST",
            },
            columns: [{
                    data: 'DT_RowIndex',
        ...
        let data_upload = $('#draft_upload').DataTable({
            ...
            lengthMenu: [5, 10, 20, 50],
            ajax: {
                "url": "{{ route('upload_kkpd.draft_upload') }}",
                "type": "POST",
            },
            columns: [{
                    data: 'DT_RowIndex',
        ...
        let transaksi_data = $('#data_transaksi1').DataTable({
            ...
            processing: true,
            ajax: {
                "url": "{{ route('upload_kkpd.data_upload') }}",
                "type": "POST",
                "data": function(d) {
        ...
        let rekening_transaksi = $('#rekening_transaksi').DataTable({
            ...
            processing: true,
            ajax: {
                "url": "{{ route('upload_kkpd.rekening_transaksi') }}",
                "type": "POST",
                "data": function(d) {
        ...
        let rekening_potongan = $('#rekening_potongan').DataTable({
            ...
            processing: true,
            ajax: {
                "url": "{{ route('upload_kkpd.rekening_potongan') }}",
                "type": "POST",
                "data": function(d) {
                    d.nomor = document.getElementById('nomor').value;
                    d.kd_skpd = document.getElementById('kd_skpd').value;
        ...
        let rekening_tujuan = $('#rekening_tujuan').DataTable({
            ...
            processing: true,
            ajax: {
                "url": "{{ route('upload_kkpd.rekening_tujuan') }}",
                "type": "POST",
                "data": function(d) {
                    d.nomor = document.getElementById('nomor').value;
                    d.kd_skpd = document.getElementById('kd_skpd').value;
    ...
    function batalUpload(no_upload, kd_skpd, no_voucher) {
        ...
        if (tanya == true) {
            $.ajax({
                url: "{{ route('upload_kkpd.batal_upload') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    no_upload: no_upload,
                ...
                success: function(data) {
                    if (data.message == '1') {
                        ...
                        window.location.href = "{{ route('upload_kkpd.index') }}";
                    } else {
