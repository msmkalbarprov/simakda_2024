...
@section('title', 'SPP GU KKPD | SIMAKDA')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    List SPP GU KKPD
                    <a href="{{ route('spp_gu_kkpd.tambah') }}" class="btn btn-primary" style="float: right;"
                        {{ $kunci == 1 ? 'hidden' : '' }}>Tambah</a>
                </div>
                <div class="card-body">
                    <div class="table-rep-plugin">
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            <table id="spp_gu_kkpd" class="table" style="width: 100%">
                                <thead>
                                    <tr>
...
@endsection
@section('js')
    @include('skpd.spp_gu_kkpd.js.index')
@endsection
