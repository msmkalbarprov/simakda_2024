...
<body>
    ...
    <table style="width: 100%;font-family:'Open Sans', Helvetica,Arial,sans-serif;text-align:center">
        <tr>
            <td style="font-size: 16px">SURAT PERMINTAAN PEMBAYARAN GANTI UANG PERSEDIAN</td>
        </tr>
        <tr>
            <td style="font-size: 16px">(SPP - GANTI UANG PERSEDIAN)</td>
        </tr>
        <tr>
    ...
    <table style="width: 100%;font-family:'Open Sans', Helvetica,Arial,sans-serif" class="rincian">
        <tr>
            <td style="text-align: justify">Dengan memperhatikan Peraturan Gubernur Kalimantan Barat
                {{ $nogub }}
                tentang Penjabaran APBD Tahun Anggaran {{ tahun_anggaran() }},
                bersama ini kami mengajukan Surat Permintaan Pembayaran Langsung Barang dan Jasa sebagai berikut:</td>
        </tr>
    </table>
