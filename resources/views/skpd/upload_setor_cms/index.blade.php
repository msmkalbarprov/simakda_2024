...
@section('title', 'Upload Setor CMS | SIMAKDA')
@section('content')
    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body" id="card_transaksi">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-7">
                                        <a href="{{ route('skpd.upload_setor.create') }}" class="btn btn-primary"
                                            style="float: right;">Tambah Upload</a>
                                    </div>
                                </div>
                                <div class="table-rep-plugin">
                                    <div class="table-responsive mb-0" data-pattern="priority-columns">
                                        <table id="upload_setor" class="table" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 50px;text-align:center">Nilai Setor</th>
...
@endsection
@section('js')
    @include('skpd.upload_setor_cms.js.index')
@endsection
