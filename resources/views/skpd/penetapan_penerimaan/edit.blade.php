...
@section('title', 'Ubah Data Penetapan | SIMAKDA')
@section('content')
    <div class="row">
        {{-- Input form --}}
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="text" id="nomor" name="nomor"
                                value="{{ $tetap->no_tetap }}" required readonly>
                        </div>
                        <div class="col-md-4">
                            <div class="form-check form-switch form-switch-lg">
                                <input type="checkbox" class="form-check-input" id="pilihan"
                                    {{ $tetap->sts_tetap == '0' ? 'checked' : '' }}>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="text" id="nama_akun" name="nama_akun"
                                value="{{ nama_rekening($tetap->kd_rek6) }}" required readonly>
                    ...
                    <div class="mb-3 row">
                            ...
                            <select class="form-control select2-multiple" style="width: 100%" id="kode_pengirim"
                                ...
                                @foreach ($daftar_pengirim as $pengirim)
                                    <option value="{{ $pengirim->kd_pengirim }}" data-nama="{{ $pengirim->nm_pengirim }}"
                                        {{ $tetap->sumber == $pengirim->kd_pengirim ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="text" id="nama_pengirim" name="nama_pengirim"
                                value="{{ nama_sumber($tetap->sumber) }}" required readonly>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="text" id="kd_sub_kegiatan" name="kd_sub_kegiatan"
                                required readonly value="{{ $tetap->kd_sub_kegiatan }}">
                        </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <select class="form-control select2-multiple" style="width: 100%" id="jenis_pembayaran"
                                ...
                                <option value="" disabled selected>Silahkan Pilih</option>
                                <option value="BANK" {{ $tetap->jns_pembayaran == 'BANK' ? 'selected' : '' }}>BANK
                                </option>
                                <option value="TUNAI" {{ $tetap->jns_pembayaran == 'TUNAI' ? 'selected' : '' }}>TUNAI
                                </option>
                                </option>
                            </select>
                        </div>
...
@endsection
@section('js')
    @include('skpd.penetapan_penerimaan.js.edit');
@endsection
