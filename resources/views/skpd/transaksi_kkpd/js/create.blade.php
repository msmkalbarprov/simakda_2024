<script>
    $(document).ready(function() {
        ...
        // no bukti
        $.ajax({
            url: "{{ route('skpd.transaksi_kkpd.no_urut') }}",
            type: "POST",
            dataType: 'json',
        ...
        $('#simpan_cms').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('skpd.transaksi_kkpd.cek_simpan') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    no_bukti: no_bukti
        ...
        function simpan_cms(response) {
            $.ajax({
                url: "{{ route('skpd.transaksi_kkpd.simpan_cms') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    data: response
        ...
        function simpan_detail_cms(response) {
            $.ajax({
                url: "{{ route('skpd.transaksi_kkpd.simpan_detail_cms') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    data: response
                ...
                success: function(data) {
                    if (data.message == '0') {
                        ...
                        window.location.href = "{{ route('skpd.transaksi_kkpd.index') }}";
                    }
                }
            })
        }
        ...
        function cari_kegiatan(beban, kd_skpd) {
            $.ajax({
                url: "{{ route('skpd.transaksi_kkpd.kegiatan') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    beban: beban,
        ...
        function cari_nomor(kd_sub_kegiatan) {
            $.ajax({
                url: "{{ route('skpd.transaksi_kkpd.nomor_sp2d') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    kd_sub_kegiatan: kd_sub_kegiatan,
        ...
        function cari_rekening(no_sp2d) {
            $.ajax({
                url: "{{ route('skpd.transaksi_kkpd.rekening') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    no_sp2d: no_sp2d,
        ...
        function cari_sumber(kd_rek6) {
            $.ajax({
                url: "{{ route('skpd.transaksi_kkpd.sumber') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    kd_rek6: kd_rek6,
        ...
        function load_sisa_bank() {
            $.ajax({
                url: "{{ route('skpd.transaksi_kkpd.sisa_bank') }}",
                type: "POST",
                dataType: 'json',
                success: function(data) {
                    let nilai = parseFloat(data) || 0;
                    let persen = document.getElementById('persen_kkpd').value;
                    let beban = document.getElementById('beban').value;
                    let sisa_kas;
                    if (beban == 1) {
                        sisa_kas = (persen / 100) * nilai;
                    } else {
                        sisa_kas = nilai;
                    }
        ...
        function load_potongan_ls(no_sp2d) {
            $.ajax({
                url: "{{ route('skpd.transaksi_kkpd.potongan_ls') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    no_sp2d: no_sp2d
        ...
        function load_dana(sumber) {
            $.ajax({
                url: "{{ route('skpd.transaksi_kkpd.load_dana') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    kd_sub_kegiatan: document.getElementById('kd_sub_kegiatan').value,
        ...
        function status_anggaran() {
            $.ajax({
                url: "{{ route('skpd.transaksi_kkpd.status_ang') }}",
                type: "POST",
                dataType: 'json',
                success: function(data) {
        ...
        function load_angkas() {
            ...
            $.ajax({
                url: "{{ route('skpd.transaksi_kkpd.load_angkas') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    kd_sub_kegiatan: kd_sub_kegiatan,
        ...
        function load_angkas_lalu() {
            ...
            $.ajax({
                url: "{{ route('skpd.transaksi_kkpd.load_angkas_lalu') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    kd_sub_kegiatan: kd_sub_kegiatan,
        ...
        function load_spd() {
            ...
            $.ajax({
                url: "{{ route('skpd.transaksi_kkpd.load_spd') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    kd_sub_kegiatan: kd_sub_kegiatan,
