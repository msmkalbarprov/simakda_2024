...
<head>
    ...
    <title>BUKU PEMBANTU BANK PENERIMAAN</title>
    <style>
        table {
...
<body>
    <table style="border-collapse:collapse;font-family: Open Sans; font-size:18px" width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
        <tr>
    ...
    <table style="border-collapse:collapse;font-family: Open Sans; font-size:14px" width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td style="text-align: center"><b>BUKU PEMBANTU BANK</td>
        </tr>
        <tr>
    ...
    {{-- isi --}}
    <table style='border-collapse:collapse;font-family: Open Sans;' width='100%' align='center' border='1' cellspacing='1' cellpadding='{{$enter}}'>
		<thead>		   
            <tr>
                ...
                <td bgcolor='#CCCCCC' align='center' width="40%"><b>Uraian</b></td>
        ...
        <tbody>
            <tr><td style="font-size:14px" align='right' colspan="6">Saldo Lalu</td>
