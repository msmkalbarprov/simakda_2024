            ...
            <div class="modal-body">
                ...
                <div class="mb-3 row" id="row-hidden2">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control select2-multiple @error('pajak2') is-invalid @enderror" style=" width: 100%;" id="pajak2" name="pajak2" data-placeholder="Silahkan Pilih">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control select2-multiple @error('pajak3') is-invalid @enderror" style=" width: 100%;" id="pajak3" name="pajak3" data-placeholder="Silahkan Pilih" disabled>
                        </select>
                        @error('pajak3')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 row" id="row-hidden">
                    <div class="col-md-6">
                        ...
                        <select class="form-control select2-modal @error('kd_skpd2') is-invalid @enderror" style=" width: 100%;" id="kd_skpd2" name="kd_skpd2">
                            <option value="" disabled selected>Silahkan Pilih</option>
                        </select>
                        @error('kd_skpd')
                        <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control select2-modal @error('bendahara2') is-invalid @enderror" style=" width: 100%;" id="bendahara2" name="bendahara2">
                            <option value="" disabled selected>Silahkan Pilih</option>
                        </select>
                        @error('bendahara2')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="mb-3 row">
                    <div class="col-md-6">
                        ...
                        <select name="jns_anggaran2" class="form-control select2-modal @error('jns_anggaran2') is-invalid @enderror" style=" width: 100%;" id="jns_anggaran2">
                            <option value="" selected disabled>Silahkan Pilih</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control select2-modal @error('pa_kpa2') is-invalid @enderror" style=" width: 100%;" id="pa_kpa2" name="pa_kpa2">
                            <option value="" disabled selected>Silahkan Pilih</option>
                        </select>
                        @error('pa_kpa2')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="mb-3 row">
                    <div class="col-md-6">
                        ...
                        <select class="form-control select2-modal @error('subkegiatan') is-invalid @enderror" style=" width: 100%;" id="subkegiatan" name="subkegiatan">
                            <option value="" disabled selected>Silahkan Pilih</option>
                        </select>
                        @error('subkegiatan')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="mb-3 row">
                    <div class="col-md-6">
                        ...
                        <select class="form-control select2-modal @error('akunbelanja') is-invalid @enderror" style=" width: 100%;" id="akunbelanja" name="akunbelanja">
                            <option value="" disabled selected>Silahkan Pilih</option>
                        </select>
                        @error('akunbelanja')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="mb-3 row">
                    <div class="col-md-6" id="jenissro">
                        ...
                        <select class="form-control select2-modal" id="jns_cetaksubrincianobjek" name="jns_cetaksubrincianobjek">
                            <option value="" disabled selected>Silahkan Pilih</option>
                ...
                <div class="mb-3 row">
                    <div class="col-md-12 text-center">
                        <button type="button" class="btn btn-danger btn-md bku_pdf" data-jenis="pdf" name="bku_pdf"> PDF</button>
                        <button type="button" class="btn btn-dark btn-md bku_layar" data-jenis="layar" name="bku_layar">Layar</button>
                        <button type="button" class="btn btn-dark btn-md bku_excel" data-jenis="excel" name="bku_excel">excel</button>
                        <button type="button" class="btn btn-md btn-secondary" data-bs-dismiss="modal">Tutup</button>
                    </div>
                </div>
            </div>
