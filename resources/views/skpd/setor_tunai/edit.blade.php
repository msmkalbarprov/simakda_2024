...
@section('title', 'Edit Setor Tunai Ke Bank | SIMAKDA')
@section('content')
    <div class="row">
        {{-- Input form --}}
        <div class="col-12">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            ...
                            <input type="text" class="form-control" id="bank_tujuan1"
                                value="{{ $setor->bank_tujuan }}" readonly hidden>
                        </div>
                    </div>
                    {{-- Sisa Kas Tunai --}}
                    <div class="mb-3 row">
...
@endsection
@section('js')
    @include('skpd.setor_tunai.js.edit');
@endsection
