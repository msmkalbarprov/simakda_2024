<script>
    $(document).ready(function() {
        ...
        let bank = document.getElementById('bank_tujuan1').value;
        $.ajax({
        ...
        $('#simpan_setor').on('click', function() {
            ...
            if (!nama_tujuan || !rekening_tujuan || !bank_tujuan) {
                alert('Isian Rekening Tujuan Belum Lengkap!');
                return;
            }
            ...
            $.ajax({
                url: "{{ route('skpd.setor_tunai.update') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    data: data
