...
@section('title', 'Input LPJ KKPD (SKPD Tanpa Unit) | SIMAKDA')
@section('content')
    <div class="row">
        {{-- Input form --}}
        <div class="col-12">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-prepend">
                                    <input type="text" value="/LPJ/KKPD/{{ $skpd->kd_skpd }}/{{ tahun_anggaran() }}"
                    ...
                    <div class="mb-6 row" style="text-align;center">
                        <div class="col-md-12" style="text-align: center">
                            ...
                            <a href="{{ route('lpj_kkpd_tanpa_unit.index') }}" class="btn btn-warning btn-md">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
...
@endsection
@section('js')
    @include('skpd.lpj_kkpd.skpd_tanpa_unit.js.create');
@endsection
