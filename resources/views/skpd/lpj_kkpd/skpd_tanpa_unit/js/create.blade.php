<script>
    $(document).ready(function() {
        ...
        $('#tampilkan').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('lpj_kkpd_tanpa_unit.detail') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    tgl_awal: tgl_awal,
        ...
        $('#simpan').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('lpj_kkpd_tanpa_unit.cek_kendali') }}",
                type: "POST",
                dataType: 'json',
                async: false,
                data: {
            ...
            if (nilai_up < total) {
                alert('Total pengajuan melebihi nilai UP');
                return;
            }
            ...
            $.ajax({
                url: "{{ route('lpj_kkpd_tanpa_unit.simpan') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    data: data
                ...
                success: function(response) {
                    if (response.message == '1') {
                        ...
                        window.location.href =
                            "{{ route('lpj_kkpd_tanpa_unit.index') }}";
