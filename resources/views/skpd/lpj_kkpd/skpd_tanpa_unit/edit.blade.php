...
@section('title', 'Ubah LPJ KKPD (SKPD Tanpa Unit) | SIMAKDA')
@section('content')
    <div class="row">
        {{-- Input form --}}
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-8">
                            <button class="btn btn-success" id="tampilkan" hidden><i class="uil-eye"></i>
                                Tampilkan</button>
                            <button href="#" class="btn btn-success" id="kosongkan" hidden><i
                                    class="uil-trash"></i>
                                Kosongkan</button>
                        </div>
                    </div>
...
@endsection
@section('js')
    @include('skpd.lpj_kkpd.skpd_tanpa_unit.js.edit');
@endsection
