<script>
    $(document).ready(function() {
        ...
        $('#skpd_atau_unit').DataTable({
            ...
            lengthMenu: [5, 10],
            ajax: {
                "url": "{{ route('lpj_kkpd_atau_unit.load_data') }}",
                "type": "POST",
            },
        ...
        $('#pilihan').on('select2:select', function() {
            ...
            if (pilihan != '2') {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('lpj_kkpd_atau_unit.sub_kegiatan') }}",
                    dataType: 'json',
                    data: {
        ...
        $('.sptb').on('click', function() {
            ...
            let url = new URL("{{ route('lpj_kkpd_atau_unit.cetak_sptb') }}");
        ...
        $('.rincian').on('click', function() {
            ...
            let url = new URL("{{ route('lpj_kkpd_atau_unit.rincian') }}");
            let searchParams = url.searchParams;
            searchParams.append("no_lpj", no_lpj);
            searchParams.append("kd_skpd", kd_skpd);
            searchParams.append("pa_kpa", pa_kpa);
    ...
    function hapus(no_lpj, kd_skpd) {
        ...
        if (tanya == true) {
            $.ajax({
                url: "{{ route('lpj_kkpd_atau_unit.hapus') }}",
                type: "POST",
                dataType: 'json',
                data: {
                    no_lpj: no_lpj,
