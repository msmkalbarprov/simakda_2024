...
<body>
    ...
    <br>
    <br>
    <table style="border-collapse:collapse;font-family: Open Sans">
        <tr>
            <td>Yang bertanda tangan di bawah ini adalah {{ $pa_kpa->jabatan }} Satuan Kerja {{ nama_skpd($kd_skpd) }}
                Menyatakan bahwa
                saya
        ...
        <tr>
            <td>Bukti-bukti belanja tertera dalam Laporan Pertanggung Jawaban Ganti Uang disimpan sesuai ketentuan yang
                berlaku pada sistem Satuan Kerja {{ nama_skpd($kd_skpd) }}
