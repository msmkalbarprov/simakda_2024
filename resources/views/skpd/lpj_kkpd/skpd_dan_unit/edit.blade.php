...
@section('title', 'Ubah LPJ KKPD (SKPD + Unit) | SIMAKDA')
@section('content')
    <div class="row">
        {{-- Input form --}}
        <div class="col-12">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-prepend">
                                    <input type="text"
                                        value="/LPJ/GLOBAL/KKPD/{{ $skpd->kd_skpd }}/{{ tahun_anggaran() }}"
                    ...
                    <div class="mb-6 row" style="text-align;center">
                        <div class="col-md-12" style="text-align: center">
                            ...
                            @endif
                            <a href="{{ route('lpj_kkpd_dan_unit.index') }}" class="btn btn-warning btn-md">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table id="detail_lpj" class="table" style="width: 100%">
                        ...
                        <tbody>
                            ...
                            @foreach ($detail_lpj as $detail)
                                ...
                                @endphp
                                <tr>
                                    <td>{{ $detail->lpj_global }}</td>
                                    <td>{{ $detail->kd_skpd }}</td>
                                    <td>{{ nama_skpd($detail->kd_skpd) }}</td>
                                    <td>{{ $detail->no_lpj }}</td>
                                    <td>{{ rupiah($detail->nilai) }}</td>
                                    <td>
                                        <a href="javascript:void(0);"
                                            onclick="hapus('{{ $detail->no_lpj }}','{{ $detail->kd_skpd }}','{{ $detail->kd_skpd }}')"
...
@endsection
@section('js')
    @include('skpd.lpj_kkpd.skpd_dan_unit.js.edit');
@endsection
