        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    List LPJ UP/GU
                    <a href="{{ route('lpj_kkpd_dan_unit.tambah') }}" class="btn btn-primary" style="float: right;">Tambah</a>
                </div>
                <div class="card-body">
                    <div class="table-rep-plugin">
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            <table id="skpd_dan_unit" class="table" style="width: 100%">
                                <thead>
                                    <tr>
...
@endsection
@section('js')
    @include('skpd.lpj_kkpd.skpd_dan_unit.js.index')
@endsection
