...
@section('title', 'Koreksi Transaksi Nominal | SIMAKDA')
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('koreksi_nominal.create') }}" class="btn btn-primary {{kunci()->kunci_jurnal== 1 ? 'hidden' : ''}}" style="float: right;">Tambah</a>
                ...
                <div class="card-body">
                    <div class="table-rep-plugin">
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            <table id="koreksi_nominal" class="table" style="width: 100%">
                                <thead>
                                    <tr>
...
@endsection
@section('js')
    @include('skpd.koreksi_nominal.js.index')
@endsection
