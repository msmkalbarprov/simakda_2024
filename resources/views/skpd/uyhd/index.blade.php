        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    Listing Data UYHD
                    <a href="{{ route('skpd.uyhd.create') }}" class="btn btn-primary" style="float: right;">Tambah</a>
                </div>
                <div class="card-body">
                    <div class="table-rep-plugin">
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            <table id="uyhd" class="table" style="width: 100%">
                                <thead>
                                    <tr>
